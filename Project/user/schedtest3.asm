...
user/_schedtest3:     file format elf64-littleriscv
...
int main(int argc, char *argv[])
{
  ...
  16:	83e98993          	addi	s3,s3,-1986 # 850 <malloc+0xe6>
  ...
  28:	c4b1                	beqz	s1,74 <main+0x74>
        int pid = fork();
  2a:	00000097          	auipc	ra,0x0
  2e:	2da080e7          	jalr	730(ra) # 304 <fork>
        if (pid < 0)
  ...
  3c:	4529                	li	a0,10
  3e:	4125053b          	subw	a0,a0,s2
  42:	00000097          	auipc	ra,0x0
  46:	38a080e7          	jalr	906(ra) # 3cc <settickets>
  4a:	009507b7          	lui	a5,0x950
  4e:	2f978793          	addi	a5,a5,761 # 9502f9 <base+0x94f2e9>
  52:	07a6                	slli	a5,a5,0x9
  ...
  5e:	80650513          	addi	a0,a0,-2042 # 860 <malloc+0xf6>
  62:	00000097          	auipc	ra,0x0
  66:	64a080e7          	jalr	1610(ra) # 6ac <printf>
            exit(0);
  6a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41c:	46850513          	addi	a0,a0,1128 # 880 <digits>
 420:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	39cb8b93          	addi	s7,s7,924 # 880 <digits>
 ...
 628:	25490913          	addi	s2,s2,596 # 878 <malloc+0x10e>
        while(*s != 0){

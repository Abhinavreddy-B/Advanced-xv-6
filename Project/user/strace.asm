...
int main(int argc,char* argv[]){
  ...
  14:	84058593          	addi	a1,a1,-1984 # 850 <malloc+0xee>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	65c080e7          	jalr	1628(ra) # 676 <fprintf>
        exit(1);
  22:	4505                	li	a0,1
  ...
  64:	81858593          	addi	a1,a1,-2024 # 878 <malloc+0x116>
  68:	4509                	li	a0,2
  6a:	00000097          	auipc	ra,0x0
  6e:	60c080e7          	jalr	1548(ra) # 676 <fprintf>
        exit(1);
  72:	4505                	li	a0,1

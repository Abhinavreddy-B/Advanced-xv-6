...
int main(int argc,char* argv[]){
  ...
  1e:	63c080e7          	jalr	1596(ra) # 656 <fprintf>
        exit(1);
  22:	4505                	li	a0,1
  ...
  34:	1d8080e7          	jalr	472(ra) # 208 <atoi>
  38:	00000097          	auipc	ra,0x0
  3c:	36c080e7          	jalr	876(ra) # 3a4 <trace>
    if(exec(argv[2],&argv[2]) == -1){
  40:	01048593          	addi	a1,s1,16
  44:	6888                	ld	a0,16(s1)
  46:	00000097          	auipc	ra,0x0
  4a:	2f6080e7          	jalr	758(ra) # 33c <exec>
  4e:	57fd                	li	a5,-1
  ...
  64:	7f858593          	addi	a1,a1,2040 # 858 <malloc+0x116>
  68:	4509                	li	a0,2
  6a:	00000097          	auipc	ra,0x0
  6e:	5ec080e7          	jalr	1516(ra) # 656 <fprintf>
        exit(1);
  72:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	49050513          	addi	a0,a0,1168 # 880 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	3c4b8b93          	addi	s7,s7,964 # 880 <digits>
 ...
 600:	27c90913          	addi	s2,s2,636 # 878 <malloc+0x136>
        while(*s != 0){

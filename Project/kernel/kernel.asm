...
0000000080000000 <_entry>:
    ...
    80000004:	ca010113          	addi	sp,sp,-864 # 80008ca0 <stack0>
...
000000008000008e <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdbc2f>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80000130:	66c080e7          	jalr	1644(ra) # 80002798 <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    8000018e:	b1650513          	addi	a0,a0,-1258 # 80010ca0 <cons>
  ...
  while(n > 0){
    ...
    8000019e:	b0648493          	addi	s1,s1,-1274 # 80010ca0 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    800001a6:	b9690913          	addi	s2,s2,-1130 # 80010d38 <cons+0x98>
    }
  ...
  while(n > 0){
    ...
    800001cc:	41a080e7          	jalr	1050(ra) # 800025e2 <killed>
    800001d0:	e535                	bnez	a0,8000023c <consoleread+0xd8>
      sleep(&cons.r, &cons.lock);
    800001d2:	85a6                	mv	a1,s1
    800001d4:	854a                	mv	a0,s2
    800001d6:	00002097          	auipc	ra,0x2
    800001da:	00c080e7          	jalr	12(ra) # 800021e2 <sleep>
    while(cons.r == cons.w){
    ...
    80000216:	530080e7          	jalr	1328(ra) # 80002742 <either_copyout>
  ...
  release(&cons.lock);
    ...
    8000022a:	a7a50513          	addi	a0,a0,-1414 # 80010ca0 <cons>
  ...
  return target - n;
    ...
    80000240:	a6450513          	addi	a0,a0,-1436 # 80010ca0 <cons>
    ...
    80000276:	acf72323          	sw	a5,-1338(a4) # 80010d38 <cons+0x98>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800002d0:	9d450513          	addi	a0,a0,-1580 # 80010ca0 <cons>
  ...
  case C('P'):  // Print process list.
    ...
    800002f6:	4fc080e7          	jalr	1276(ra) # 800027ee <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    ...
    800002fe:	9a650513          	addi	a0,a0,-1626 # 80010ca0 <cons>
  ...
  switch(c){
    ...
    80000322:	98270713          	addi	a4,a4,-1662 # 80010ca0 <cons>
    ...
    8000034c:	95878793          	addi	a5,a5,-1704 # 80010ca0 <cons>
    ...
    8000037a:	9c27a783          	lw	a5,-1598(a5) # 80010d38 <cons+0x98>
    ...
    8000038e:	91670713          	addi	a4,a4,-1770 # 80010ca0 <cons>
    80000392:	0a072783          	lw	a5,160(a4)
    80000396:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    8000039a:	00011497          	auipc	s1,0x11
    8000039e:	90648493          	addi	s1,s1,-1786 # 80010ca0 <cons>
    while(cons.e != cons.w &&
    ...
    800003da:	8ca70713          	addi	a4,a4,-1846 # 80010ca0 <cons>
    ...
    800003f0:	94f72a23          	sw	a5,-1708(a4) # 80010d40 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80000416:	88e78793          	addi	a5,a5,-1906 # 80010ca0 <cons>
    ...
    8000043a:	90c7a323          	sw	a2,-1786(a5) # 80010d3c <cons+0x9c>
        wakeup(&cons.r);
    8000043e:	00011517          	auipc	a0,0x11
    80000442:	8fa50513          	addi	a0,a0,-1798 # 80010d38 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000464:	84050513          	addi	a0,a0,-1984 # 80010ca0 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    8000047c:	5c078793          	addi	a5,a5,1472 # 80021a38 <devsw>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    8000054e:	8007ab23          	sw	zero,-2026(a5) # 80010d60 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80000582:	5af72123          	sw	a5,1442(a4) # 80008b20 <panicked>
  for(;;)
...
0000000080000588 <printf>:
{
  ...
  locking = pr.locking;
    ...
    800005be:	7a6dad83          	lw	s11,1958(s11) # 80010d60 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    800005fc:	75050513          	addi	a0,a0,1872 # 80010d48 <pr>
  ...
  if(locking)
    ...
    8000075a:	5f250513          	addi	a0,a0,1522 # 80010d48 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80000776:	5d648493          	addi	s1,s1,1494 # 80010d48 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800007d6:	59650513          	addi	a0,a0,1430 # 80010d68 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000802:	3227a783          	lw	a5,802(a5) # 80008b20 <panicked>
    for(;;)
      ;
  }
...
uartstart()
{
  while(1){
    ...
    8000083a:	2f27b783          	ld	a5,754(a5) # 80008b28 <uart_tx_r>
    8000083e:	00008717          	auipc	a4,0x8
    80000842:	2f273703          	ld	a4,754(a4) # 80008b30 <uart_tx_w>
    80000846:	06f70a63          	beq	a4,a5,800008ba <uartstart+0x84>
{
    ...
    80000864:	508a0a13          	addi	s4,s4,1288 # 80010d68 <uart_tx_lock>
    uart_tx_r += 1;
    80000868:	00008497          	auipc	s1,0x8
    8000086c:	2c048493          	addi	s1,s1,704 # 80008b28 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80000870:	00008997          	auipc	s3,0x8
    80000874:	2c098993          	addi	s3,s3,704 # 80008b30 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    ...
    80000896:	b00080e7          	jalr	-1280(ra) # 80002392 <wakeup>
...
00000000800008bc <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    800008d2:	49a50513          	addi	a0,a0,1178 # 80010d68 <uart_tx_lock>
    800008d6:	00000097          	auipc	ra,0x0
    800008da:	300080e7          	jalr	768(ra) # 80000bd6 <acquire>
  if(panicked){
    800008de:	00008797          	auipc	a5,0x8
    800008e2:	2427a783          	lw	a5,578(a5) # 80008b20 <panicked>
    800008e6:	e7c9                	bnez	a5,80000970 <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800008e8:	00008717          	auipc	a4,0x8
    800008ec:	24873703          	ld	a4,584(a4) # 80008b30 <uart_tx_w>
    800008f0:	00008797          	auipc	a5,0x8
    800008f4:	2387b783          	ld	a5,568(a5) # 80008b28 <uart_tx_r>
    800008f8:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    800008fc:	00010997          	auipc	s3,0x10
    80000900:	46c98993          	addi	s3,s3,1132 # 80010d68 <uart_tx_lock>
    80000904:	00008497          	auipc	s1,0x8
    80000908:	22448493          	addi	s1,s1,548 # 80008b28 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000090c:	00008917          	auipc	s2,0x8
    80000910:	22490913          	addi	s2,s2,548 # 80008b30 <uart_tx_w>
    80000914:	00e79f63          	bne	a5,a4,80000932 <uartputc+0x76>
    sleep(&uart_tx_r, &uart_tx_lock);
    80000918:	85ce                	mv	a1,s3
    8000091a:	8526                	mv	a0,s1
    8000091c:	00002097          	auipc	ra,0x2
    80000920:	8c6080e7          	jalr	-1850(ra) # 800021e2 <sleep>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80000936:	43648493          	addi	s1,s1,1078 # 80010d68 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    8000094a:	1ee7b523          	sd	a4,490(a5) # 80008b30 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    800009c0:	3ac48493          	addi	s1,s1,940 # 80010d68 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a02:	1d278793          	addi	a5,a5,466 # 80022bd0 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a22:	38290913          	addi	s2,s2,898 # 80010da0 <kmem>
...
0000000080000aaa <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000abe:	2e650513          	addi	a0,a0,742 # 80010da0 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ad2:	10250513          	addi	a0,a0,258 # 80022bd0 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000af4:	2b048493          	addi	s1,s1,688 # 80010da0 <kmem>
  ...
  if(r)
    ...
    80000b0c:	29850513          	addi	a0,a0,664 # 80010da0 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b38:	26c50513          	addi	a0,a0,620 # 80010da0 <kmem>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000e8c:	cb070713          	addi	a4,a4,-848 # 80008b38 <started>
  if(cpuid() == 0){
    ...
    80000ec2:	a7c080e7          	jalr	-1412(ra) # 8000293a <trapinithart>
  ...
  scheduler();        
    ...
    80000ed2:	0d8080e7          	jalr	216(ra) # 80001fa6 <scheduler>
    consoleinit();
    ...
    80000f3a:	9dc080e7          	jalr	-1572(ra) # 80002912 <trapinit>
    trapinithart();  // install kernel trap vector
    80000f3e:	00002097          	auipc	ra,0x2
    80000f42:	9fc080e7          	jalr	-1540(ra) # 8000293a <trapinithart>
    ...
    80000f7a:	d34080e7          	jalr	-716(ra) # 80001caa <userinit>
    __sync_synchronize();
    80000f7e:	0ff0000f          	fence
    started = 1;
    80000f82:	4785                	li	a5,1
    80000f84:	00008717          	auipc	a4,0x8
    80000f88:	baf72a23          	sw	a5,-1100(a4) # 80008b38 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000f9c:	ba87b783          	ld	a5,-1112(a5) # 80008b40 <kernel_pagetable>
...
0000000080001244 <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    80001258:	8ea7b623          	sd	a0,-1812(a5) # 80008b40 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001850:	9a448493          	addi	s1,s1,-1628 # 800111f0 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000186a:	f8aa0a13          	addi	s4,s4,-118 # 800177f0 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    800018ec:	4d850513          	addi	a0,a0,1240 # 80010dc0 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    80001904:	4d850513          	addi	a0,a0,1240 # 80010dd8 <wait_lock>
    80001908:	fffff097          	auipc	ra,0xfffff
    8000190c:	23e080e7          	jalr	574(ra) # 80000b46 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    80001910:	00010497          	auipc	s1,0x10
    80001914:	8e048493          	addi	s1,s1,-1824 # 800111f0 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001936:	ebe98993          	addi	s3,s3,-322 # 800177f0 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    800019a0:	45450513          	addi	a0,a0,1108 # 80010df0 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    800019c8:	3fc70713          	addi	a4,a4,1020 # 80010dc0 <pid_lock>
...
forkret(void)
{
  ...
  usertrapret();
    ...
    80001a0a:	f4c080e7          	jalr	-180(ra) # 80002952 <usertrapret>
}
    ...
    80001a24:	fae080e7          	jalr	-82(ra) # 800039ce <fsinit>
...
0000000080001a2a <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80001a3a:	38a90913          	addi	s2,s2,906 # 80010dc0 <pid_lock>
    80001a3e:	854a                	mv	a0,s2
    80001a40:	fffff097          	auipc	ra,0xfffff
    80001a44:	196080e7          	jalr	406(ra) # 80000bd6 <acquire>
  pid = nextpid;
    80001a48:	00007797          	auipc	a5,0x7
    80001a4c:	f4878793          	addi	a5,a5,-184 # 80008990 <nextpid>
...
0000000080001bb6 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001bc6:	62e48493          	addi	s1,s1,1582 # 800111f0 <proc>
    80001bca:	00016917          	auipc	s2,0x16
    80001bce:	c2690913          	addi	s2,s2,-986 # 800177f0 <tickslock>
    acquire(&p->lock);
  ...
  return 0;
    ...
    80001bf4:	a8a5                	j	80001c6c <allocproc+0xb6>
  p->pid = allocpid();
  ...
  if((p->trapframe = (struct trapframe *)kalloc()) == 0){
    ...
    80001c10:	c52d                	beqz	a0,80001c7a <allocproc+0xc4>
  ...
  if(p->pagetable == 0){
    80001c20:	c92d                	beqz	a0,80001c92 <allocproc+0xdc>
  ...
  p->ctime = ticks;
    ...
    80001c52:	f027a783          	lw	a5,-254(a5) # 80008b50 <ticks>
  ...
  p->tickets = 1;
    ...
    80001c68:	18f4a823          	sw	a5,400(s1)
}
    ...
    80001c80:	ee2080e7          	jalr	-286(ra) # 80001b5e <freeproc>
    release(&p->lock);
    80001c84:	8526                	mv	a0,s1
    80001c86:	fffff097          	auipc	ra,0xfffff
    80001c8a:	004080e7          	jalr	4(ra) # 80000c8a <release>
    return 0;
    80001c8e:	84ca                	mv	s1,s2
    80001c90:	bff1                	j	80001c6c <allocproc+0xb6>
    freeproc(p);
    ...
    80001ca8:	b7d1                	j	80001c6c <allocproc+0xb6>
...
0000000080001caa <userinit>:
{
  ...
  p = allocproc();
    ...
    80001cb8:	f02080e7          	jalr	-254(ra) # 80001bb6 <allocproc>
    80001cbc:	84aa                	mv	s1,a0
  initproc = p;
    80001cbe:	00007797          	auipc	a5,0x7
    80001cc2:	e8a7b523          	sd	a0,-374(a5) # 80008b48 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    80001cc6:	03400613          	li	a2,52
    80001cca:	00007597          	auipc	a1,0x7
    80001cce:	cd658593          	addi	a1,a1,-810 # 800089a0 <initcode>
    80001cd2:	6928                	ld	a0,80(a0)
    80001cd4:	fffff097          	auipc	ra,0xfffff
    80001cd8:	682080e7          	jalr	1666(ra) # 80001356 <uvmfirst>
  p->sz = PGSIZE;
  ...
  release(&p->lock);
    ...
    80001d1e:	f70080e7          	jalr	-144(ra) # 80000c8a <release>
}
...
0000000080001d2c <growproc>:
{
  ...
  struct proc *p = myproc();
    ...
    80001d3e:	c72080e7          	jalr	-910(ra) # 800019ac <myproc>
  ...
  return 0;
    ...
    80001d6a:	6aa080e7          	jalr	1706(ra) # 80001410 <uvmalloc>
    ...
    80001d80:	64c080e7          	jalr	1612(ra) # 800013c8 <uvmdealloc>
...
0000000080001d88 <fork>:
{
  ...
  struct proc *p = myproc();
    ...
    80001d9e:	c12080e7          	jalr	-1006(ra) # 800019ac <myproc>
    80001da2:	8aaa                	mv	s5,a0
  if((np = allocproc()) == 0){
    80001da4:	00000097          	auipc	ra,0x0
    80001da8:	e12080e7          	jalr	-494(ra) # 80001bb6 <allocproc>
    80001dac:	12050063          	beqz	a0,80001ecc <fork+0x144>
  ...
  if(uvmcopy(p->pagetable, np->pagetable, p->sz) < 0){
    ...
    80001dc0:	7a8080e7          	jalr	1960(ra) # 80001564 <uvmcopy>
    80001dc4:	04054c63          	bltz	a0,80001e1c <fork+0x94>
  np->sz = p->sz;
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  np->syscall_tracebits = p->syscall_tracebits;
    80001dfe:	168aa783          	lw	a5,360(s5)
    80001e02:	16f9a423          	sw	a5,360(s3)
  np->trapframe->a0 = 0;
    80001e06:	0589b783          	ld	a5,88(s3)
    80001e0a:	0607b823          	sd	zero,112(a5)
  for(i = 0; i < NOFILE; i++)
    80001e0e:	0d0a8493          	addi	s1,s5,208
    80001e12:	0d098913          	addi	s2,s3,208
    80001e16:	150a8a13          	addi	s4,s5,336
    80001e1a:	a00d                	j	80001e3c <fork+0xb4>
    freeproc(np);
    80001e1c:	854e                	mv	a0,s3
    80001e1e:	00000097          	auipc	ra,0x0
    80001e22:	d40080e7          	jalr	-704(ra) # 80001b5e <freeproc>
    release(&np->lock);
    ...
    80001e32:	a059                	j	80001eb8 <fork+0x130>
  for(i = 0; i < NOFILE; i++)
    80001e34:	04a1                	addi	s1,s1,8
    80001e36:	0921                	addi	s2,s2,8
    80001e38:	01448b63          	beq	s1,s4,80001e4e <fork+0xc6>
    if(p->ofile[i])
    80001e3c:	6088                	ld	a0,0(s1)
    80001e3e:	d97d                	beqz	a0,80001e34 <fork+0xac>
      np->ofile[i] = filedup(p->ofile[i]);
    80001e40:	00003097          	auipc	ra,0x3
    80001e44:	c46080e7          	jalr	-954(ra) # 80004a86 <filedup>
    80001e48:	00a93023          	sd	a0,0(s2)
    80001e4c:	b7e5                	j	80001e34 <fork+0xac>
  np->cwd = idup(p->cwd);
    80001e4e:	150ab503          	ld	a0,336(s5)
    80001e52:	00002097          	auipc	ra,0x2
    80001e56:	dba080e7          	jalr	-582(ra) # 80003c0c <idup>
  ...
  safestrcpy(np->name, p->name, sizeof(p->name));
    ...
    80001e6c:	fb4080e7          	jalr	-76(ra) # 80000e1c <safestrcpy>
  pid = np->pid;
    80001e70:	0309a903          	lw	s2,48(s3)
  release(&np->lock);
    80001e74:	854e                	mv	a0,s3
    80001e76:	fffff097          	auipc	ra,0xfffff
    80001e7a:	e14080e7          	jalr	-492(ra) # 80000c8a <release>
  acquire(&wait_lock);
    80001e7e:	0000f497          	auipc	s1,0xf
    80001e82:	f5a48493          	addi	s1,s1,-166 # 80010dd8 <wait_lock>
    80001e86:	8526                	mv	a0,s1
    80001e88:	fffff097          	auipc	ra,0xfffff
    80001e8c:	d4e080e7          	jalr	-690(ra) # 80000bd6 <acquire>
  np->parent = p;
    80001e90:	0359bc23          	sd	s5,56(s3)
  release(&wait_lock);
  ...
  acquire(&np->lock);
    ...
    80001ea4:	d36080e7          	jalr	-714(ra) # 80000bd6 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001ece:	b7ed                	j	80001eb8 <fork+0x130>

0000000080001ed0 <update_time>:
{
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    ...
    80001ee2:	31248493          	addi	s1,s1,786 # 800111f0 <proc>
    if (p->state == RUNNING) {
    80001ee6:	4991                	li	s3,4
  for (p = proc; p < &proc[NPROC]; p++) {
    80001ee8:	00016917          	auipc	s2,0x16
    80001eec:	90890913          	addi	s2,s2,-1784 # 800177f0 <tickslock>
    80001ef0:	a811                	j	80001f04 <update_time+0x34>
    release(&p->lock);
    80001ef2:	8526                	mv	a0,s1
    80001ef4:	fffff097          	auipc	ra,0xfffff
    80001ef8:	d96080e7          	jalr	-618(ra) # 80000c8a <release>
  for (p = proc; p < &proc[NPROC]; p++) {
    80001efc:	19848493          	addi	s1,s1,408
    80001f00:	03248063          	beq	s1,s2,80001f20 <update_time+0x50>
    acquire(&p->lock);
    80001f04:	8526                	mv	a0,s1
    80001f06:	fffff097          	auipc	ra,0xfffff
    80001f0a:	cd0080e7          	jalr	-816(ra) # 80000bd6 <acquire>
    if (p->state == RUNNING) {
    80001f0e:	4c9c                	lw	a5,24(s1)
    80001f10:	ff3791e3          	bne	a5,s3,80001ef2 <update_time+0x22>
      p->rtime++;
    80001f14:	16c4a783          	lw	a5,364(s1)
    80001f18:	2785                	addiw	a5,a5,1
    80001f1a:	16f4a623          	sw	a5,364(s1)
    80001f1e:	bfd1                	j	80001ef2 <update_time+0x22>
}
...
0000000080001f2e <do_rand>:
{
    80001f2e:	1141                	addi	sp,sp,-16
    80001f30:	e422                	sd	s0,8(sp)
    80001f32:	0800                	addi	s0,sp,16
    x = (*ctx % 0x7ffffffe) + 1;
    80001f34:	611c                	ld	a5,0(a0)
    80001f36:	80000737          	lui	a4,0x80000
    80001f3a:	ffe74713          	xori	a4,a4,-2
    80001f3e:	02e7f7b3          	remu	a5,a5,a4
    80001f42:	0785                	addi	a5,a5,1
    lo = x % 127773;
    80001f44:	66fd                	lui	a3,0x1f
    80001f46:	31d68693          	addi	a3,a3,797 # 1f31d <_entry-0x7ffe0ce3>
    80001f4a:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
    80001f4e:	6611                	lui	a2,0x4
    80001f50:	1a760613          	addi	a2,a2,423 # 41a7 <_entry-0x7fffbe59>
    80001f54:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
    80001f58:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
    80001f5c:	76fd                	lui	a3,0xfffff
    80001f5e:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <end+0xffffffff7ffdc91c>
    80001f62:	02d787b3          	mul	a5,a5,a3
    80001f66:	97ba                	add	a5,a5,a4
    if (x < 0)
    80001f68:	0007c963          	bltz	a5,80001f7a <do_rand+0x4c>
    x--;
    80001f6c:	17fd                	addi	a5,a5,-1
    *ctx = x;
    80001f6e:	e11c                	sd	a5,0(a0)
}
    80001f70:	0007851b          	sext.w	a0,a5
    80001f74:	6422                	ld	s0,8(sp)
    80001f76:	0141                	addi	sp,sp,16
    80001f78:	8082                	ret
        x += 0x7fffffff;
    80001f7a:	80000737          	lui	a4,0x80000
    80001f7e:	fff74713          	not	a4,a4
    80001f82:	97ba                	add	a5,a5,a4
    80001f84:	b7e5                	j	80001f6c <do_rand+0x3e>

0000000080001f86 <rand>:
{
    ...
    80001f8e:	00007517          	auipc	a0,0x7
    80001f92:	9fa50513          	addi	a0,a0,-1542 # 80008988 <rand_next>
    80001f96:	00000097          	auipc	ra,0x0
    80001f9a:	f98080e7          	jalr	-104(ra) # 80001f2e <do_rand>
}
    80001f9e:	60a2                	ld	ra,8(sp)
    80001fa0:	6402                	ld	s0,0(sp)
    80001fa2:	0141                	addi	sp,sp,16
    80001fa4:	8082                	ret

0000000080001fa6 <scheduler>:
{
    80001fa6:	7159                	addi	sp,sp,-112
    80001fa8:	f486                	sd	ra,104(sp)
    80001faa:	f0a2                	sd	s0,96(sp)
    80001fac:	eca6                	sd	s1,88(sp)
    80001fae:	e8ca                	sd	s2,80(sp)
    80001fb0:	e4ce                	sd	s3,72(sp)
    80001fb2:	e0d2                	sd	s4,64(sp)
    80001fb4:	fc56                	sd	s5,56(sp)
    80001fb6:	f85a                	sd	s6,48(sp)
    80001fb8:	f45e                	sd	s7,40(sp)
    80001fba:	f062                	sd	s8,32(sp)
    80001fbc:	ec66                	sd	s9,24(sp)
    80001fbe:	e86a                	sd	s10,16(sp)
    80001fc0:	e46e                	sd	s11,8(sp)
    80001fc2:	1880                	addi	s0,sp,112
    80001fc4:	8792                	mv	a5,tp
  int id = r_tp();
    80001fc6:	2781                	sext.w	a5,a5
  c->proc = 0;
    80001fc8:	00779693          	slli	a3,a5,0x7
    80001fcc:	0000f717          	auipc	a4,0xf
    80001fd0:	df470713          	addi	a4,a4,-524 # 80010dc0 <pid_lock>
    80001fd4:	9736                	add	a4,a4,a3
    80001fd6:	02073823          	sd	zero,48(a4)
        swtch(&c->context,&selected->context);
    80001fda:	0000f717          	auipc	a4,0xf
    80001fde:	e1e70713          	addi	a4,a4,-482 # 80010df8 <cpus+0x8>
    80001fe2:	00e68db3          	add	s11,a3,a4
    int total_tickets = 0;
    80001fe6:	4a81                	li	s5,0
    for (p = proc; p < &proc[NPROC]; p++)
    80001fe8:	00016997          	auipc	s3,0x16
    80001fec:	80898993          	addi	s3,s3,-2040 # 800177f0 <tickslock>
        c->proc = selected;
    80001ff0:	0000fb17          	auipc	s6,0xf
    80001ff4:	dd0b0b13          	addi	s6,s6,-560 # 80010dc0 <pid_lock>
    80001ff8:	9b36                	add	s6,s6,a3
    80001ffa:	a0f9                	j	800020c8 <scheduler+0x122>
    for (p = proc; p < &proc[NPROC]; p++)
    80001ffc:	19848493          	addi	s1,s1,408
    80002000:	01348f63          	beq	s1,s3,8000201e <scheduler+0x78>
      if (p->state == RUNNABLE)
    80002004:	4c9c                	lw	a5,24(s1)
    80002006:	ff279be3          	bne	a5,s2,80001ffc <scheduler+0x56>
        acquire(&p->lock);
    8000200a:	8526                	mv	a0,s1
    8000200c:	fffff097          	auipc	ra,0xfffff
    80002010:	bca080e7          	jalr	-1078(ra) # 80000bd6 <acquire>
        total_tickets += p->tickets;
    80002014:	1904a783          	lw	a5,400(s1)
    80002018:	01978cbb          	addw	s9,a5,s9
    8000201c:	b7c5                	j	80001ffc <scheduler+0x56>
    if(total_tickets!= 0){
    8000201e:	000c9e63          	bnez	s9,8000203a <scheduler+0x94>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    int total_tickets = 0;
    8000202e:	8cd6                	mv	s9,s5
    for (p = proc; p < &proc[NPROC]; p++)
    80002030:	0000f497          	auipc	s1,0xf
    80002034:	1c048493          	addi	s1,s1,448 # 800111f0 <proc>
    80002038:	b7f1                	j	80002004 <scheduler+0x5e>
      int randominteger = rand()%total_tickets;
    8000203a:	00000097          	auipc	ra,0x0
    8000203e:	f4c080e7          	jalr	-180(ra) # 80001f86 <rand>
    80002042:	03956cbb          	remw	s9,a0,s9
      for(p = proc; p < &proc[NPROC]; p++){
    80002046:	0000fa17          	auipc	s4,0xf
    8000204a:	1aaa0a13          	addi	s4,s4,426 # 800111f0 <proc>
    8000204e:	0000f497          	auipc	s1,0xf
    80002052:	33a48493          	addi	s1,s1,826 # 80011388 <proc+0x198>
      int preftickets = 0;
    80002056:	8756                	mv	a4,s5
      struct proc* selected = 0;
    80002058:	8c56                	mv	s8,s5
    8000205a:	a821                	j	80002072 <scheduler+0xcc>
            release(&p->lock);
    8000205c:	fffff097          	auipc	ra,0xfffff
    80002060:	c2e080e7          	jalr	-978(ra) # 80000c8a <release>
            preftickets += p->tickets;
    80002064:	876a                	mv	a4,s10
      for(p = proc; p < &proc[NPROC]; p++){
    80002066:	033bfc63          	bgeu	s7,s3,8000209e <scheduler+0xf8>
    8000206a:	198a0a13          	addi	s4,s4,408
    8000206e:	19848493          	addi	s1,s1,408
    80002072:	8552                	mv	a0,s4
        if(p->state == RUNNABLE){
    80002074:	8ba6                	mv	s7,s1
    80002076:	e804a783          	lw	a5,-384(s1)
    8000207a:	ff2796e3          	bne	a5,s2,80002066 <scheduler+0xc0>
          if(preftickets+p->tickets < randominteger){
    8000207e:	ff84ad03          	lw	s10,-8(s1)
    80002082:	00ed0d3b          	addw	s10,s10,a4
    80002086:	fd9d4be3          	blt	s10,s9,8000205c <scheduler+0xb6>
          }else if(selected == 0){ // first process which has higher cumulative tickets than random integer
    8000208a:	040c0163          	beqz	s8,800020cc <scheduler+0x126>
            release(&p->lock);
    8000208e:	fffff097          	auipc	ra,0xfffff
    80002092:	bfc080e7          	jalr	-1028(ra) # 80000c8a <release>
            preftickets += p->tickets;
    80002096:	876a                	mv	a4,s10
      for(p = proc; p < &proc[NPROC]; p++){
    80002098:	fd3be9e3          	bltu	s7,s3,8000206a <scheduler+0xc4>
    8000209c:	a019                	j	800020a2 <scheduler+0xfc>
      if(selected){
    8000209e:	f80c02e3          	beqz	s8,80002022 <scheduler+0x7c>
        selected->state = RUNNING;
    800020a2:	4791                	li	a5,4
    800020a4:	00fc2c23          	sw	a5,24(s8)
        c->proc = selected;
    800020a8:	038b3823          	sd	s8,48(s6)
        swtch(&c->context,&selected->context);
    800020ac:	060c0593          	addi	a1,s8,96
    800020b0:	856e                	mv	a0,s11
    800020b2:	00000097          	auipc	ra,0x0
    800020b6:	7f6080e7          	jalr	2038(ra) # 800028a8 <swtch>
        c->proc = 0;
    800020ba:	020b3823          	sd	zero,48(s6)
        release(&selected->lock);
    800020be:	8562                	mv	a0,s8
    800020c0:	fffff097          	auipc	ra,0xfffff
    800020c4:	bca080e7          	jalr	-1078(ra) # 80000c8a <release>
      if (p->state == RUNNABLE)
    800020c8:	490d                	li	s2,3
    800020ca:	bfa1                	j	80002022 <scheduler+0x7c>
    800020cc:	8c52                	mv	s8,s4
    800020ce:	b7e9                	j	80002098 <scheduler+0xf2>
...
00000000800020d0 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    800020ec:	a74080e7          	jalr	-1420(ra) # 80000b5c <holding>
    800020f0:	c93d                	beqz	a0,80002166 <sched+0x96>
  asm volatile("mv %0, tp" : "=r" (x) );
  ...
  if(mycpu()->noff != 1)
    ...
    800020fc:	cc870713          	addi	a4,a4,-824 # 80010dc0 <pid_lock>
    80002100:	97ba                	add	a5,a5,a4
    80002102:	0a87a703          	lw	a4,168(a5)
    80002106:	4785                	li	a5,1
    80002108:	06f71763          	bne	a4,a5,80002176 <sched+0xa6>
  if(p->state == RUNNING)
    8000210c:	4c98                	lw	a4,24(s1)
    8000210e:	4791                	li	a5,4
    80002110:	06f70b63          	beq	a4,a5,80002186 <sched+0xb6>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002114:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002118:	8b89                	andi	a5,a5,2
  if(intr_get())
    8000211a:	efb5                	bnez	a5,80002196 <sched+0xc6>
  asm volatile("mv %0, tp" : "=r" (x) );
    8000211c:	8792                	mv	a5,tp
  intena = mycpu()->intena;
    8000211e:	0000f917          	auipc	s2,0xf
    80002122:	ca290913          	addi	s2,s2,-862 # 80010dc0 <pid_lock>
    80002126:	2781                	sext.w	a5,a5
    80002128:	079e                	slli	a5,a5,0x7
    8000212a:	97ca                	add	a5,a5,s2
    8000212c:	0ac7a983          	lw	s3,172(a5)
    80002130:	8792                	mv	a5,tp
  swtch(&p->context, &mycpu()->context);
    80002132:	2781                	sext.w	a5,a5
    80002134:	079e                	slli	a5,a5,0x7
    80002136:	0000f597          	auipc	a1,0xf
    8000213a:	cc258593          	addi	a1,a1,-830 # 80010df8 <cpus+0x8>
    8000213e:	95be                	add	a1,a1,a5
    80002140:	06048513          	addi	a0,s1,96
    80002144:	00000097          	auipc	ra,0x0
    80002148:	764080e7          	jalr	1892(ra) # 800028a8 <swtch>
    8000214c:	8792                	mv	a5,tp
  mycpu()->intena = intena;
    8000214e:	2781                	sext.w	a5,a5
    80002150:	079e                	slli	a5,a5,0x7
    80002152:	97ca                	add	a5,a5,s2
    80002154:	0b37a623          	sw	s3,172(a5)
}
    ...
    8000216a:	0b250513          	addi	a0,a0,178 # 80008218 <digits+0x1d8>
    8000216e:	ffffe097          	auipc	ra,0xffffe
    80002172:	3d0080e7          	jalr	976(ra) # 8000053e <panic>
    panic("sched locks");
    80002176:	00006517          	auipc	a0,0x6
    8000217a:	0b250513          	addi	a0,a0,178 # 80008228 <digits+0x1e8>
    8000217e:	ffffe097          	auipc	ra,0xffffe
    80002182:	3c0080e7          	jalr	960(ra) # 8000053e <panic>
    panic("sched running");
    80002186:	00006517          	auipc	a0,0x6
    8000218a:	0b250513          	addi	a0,a0,178 # 80008238 <digits+0x1f8>
    8000218e:	ffffe097          	auipc	ra,0xffffe
    80002192:	3b0080e7          	jalr	944(ra) # 8000053e <panic>
    panic("sched interruptible");
    80002196:	00006517          	auipc	a0,0x6
    8000219a:	0b250513          	addi	a0,a0,178 # 80008248 <digits+0x208>
    8000219e:	ffffe097          	auipc	ra,0xffffe
    800021a2:	3a0080e7          	jalr	928(ra) # 8000053e <panic>

00000000800021a6 <yield>:
{
  ...
  struct proc *p = myproc();
    ...
    800021b4:	7fc080e7          	jalr	2044(ra) # 800019ac <myproc>
  ...
  sched();
    ...
    800021ca:	f0a080e7          	jalr	-246(ra) # 800020d0 <sched>
  release(&p->lock);
    800021ce:	8526                	mv	a0,s1
    800021d0:	fffff097          	auipc	ra,0xfffff
    800021d4:	aba080e7          	jalr	-1350(ra) # 80000c8a <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
    ...
    800021f2:	892e                	mv	s2,a1
  struct proc *p = myproc();
    800021f4:	fffff097          	auipc	ra,0xfffff
    800021f8:	7b8080e7          	jalr	1976(ra) # 800019ac <myproc>
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80002202:	9d8080e7          	jalr	-1576(ra) # 80000bd6 <acquire>
  release(lk);
  ...
  sched();
    ...
    8000221c:	eb8080e7          	jalr	-328(ra) # 800020d0 <sched>

  // Tidy up.
  p->chan = 0;
    80002220:	0204b023          	sd	zero,32(s1)

  // Reacquire original lock.
  release(&p->lock);
    80002224:	8526                	mv	a0,s1
    80002226:	fffff097          	auipc	ra,0xfffff
    8000222a:	a64080e7          	jalr	-1436(ra) # 80000c8a <release>
  acquire(lk);
...
0000000080002246 <waitx>:
{
    ...
    8000225e:	e06a                	sd	s10,0(sp)
    80002260:	1080                	addi	s0,sp,96
    80002262:	8b2a                	mv	s6,a0
    80002264:	8bae                	mv	s7,a1
    80002266:	8c32                	mv	s8,a2
  struct proc *p = myproc();
  ...
  acquire(&wait_lock);
    ...
    80002276:	b6650513          	addi	a0,a0,-1178 # 80010dd8 <wait_lock>
    8000227a:	fffff097          	auipc	ra,0xfffff
    8000227e:	95c080e7          	jalr	-1700(ra) # 80000bd6 <acquire>
    havekids = 0;
    80002282:	4c81                	li	s9,0
        if(np->state == ZOMBIE){
    ...
    8000228c:	56898993          	addi	s3,s3,1384 # 800177f0 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002290:	0000fd17          	auipc	s10,0xf
    80002294:	b48d0d13          	addi	s10,s10,-1208 # 80010dd8 <wait_lock>
    havekids = 0;
    80002298:	8766                	mv	a4,s9
    for(np = proc; np < &proc[NPROC]; np++){
    8000229a:	0000f497          	auipc	s1,0xf
    8000229e:	f5648493          	addi	s1,s1,-170 # 800111f0 <proc>
    800022a2:	a059                	j	80002328 <waitx+0xe2>
          pid = np->pid;
    800022a4:	0304a983          	lw	s3,48(s1)
          *rtime = np->rtime;
    800022a8:	16c4a703          	lw	a4,364(s1)
    800022ac:	00ec2023          	sw	a4,0(s8)
          *wtime = np->etime - np->ctime - np->rtime;
    800022b0:	1704a783          	lw	a5,368(s1)
    800022b4:	9f3d                	addw	a4,a4,a5
    800022b6:	1744a783          	lw	a5,372(s1)
    800022ba:	9f99                	subw	a5,a5,a4
    800022bc:	00fba023          	sw	a5,0(s7) # fffffffffffff000 <end+0xffffffff7ffdc430>
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&np->xstate,
    800022c0:	000b0e63          	beqz	s6,800022dc <waitx+0x96>
    800022c4:	4691                	li	a3,4
    800022c6:	02c48613          	addi	a2,s1,44
    800022ca:	85da                	mv	a1,s6
    800022cc:	05093503          	ld	a0,80(s2)
    800022d0:	fffff097          	auipc	ra,0xfffff
    800022d4:	398080e7          	jalr	920(ra) # 80001668 <copyout>
    800022d8:	02054563          	bltz	a0,80002302 <waitx+0xbc>
          freeproc(np);
    800022dc:	8526                	mv	a0,s1
    800022de:	00000097          	auipc	ra,0x0
    800022e2:	880080e7          	jalr	-1920(ra) # 80001b5e <freeproc>
          release(&np->lock);
    ...
    800022f4:	ae850513          	addi	a0,a0,-1304 # 80010dd8 <wait_lock>
    800022f8:	fffff097          	auipc	ra,0xfffff
    800022fc:	992080e7          	jalr	-1646(ra) # 80000c8a <release>
          return pid;
    80002300:	a09d                	j	80002366 <waitx+0x120>
            release(&np->lock);
    ...
    80002310:	acc50513          	addi	a0,a0,-1332 # 80010dd8 <wait_lock>
    80002314:	fffff097          	auipc	ra,0xfffff
    80002318:	976080e7          	jalr	-1674(ra) # 80000c8a <release>
            return -1;
    8000231c:	59fd                	li	s3,-1
    8000231e:	a0a1                	j	80002366 <waitx+0x120>
    for(np = proc; np < &proc[NPROC]; np++){
    80002320:	19848493          	addi	s1,s1,408
    80002324:	03348463          	beq	s1,s3,8000234c <waitx+0x106>
      if(np->parent == p){
    80002328:	7c9c                	ld	a5,56(s1)
    8000232a:	ff279be3          	bne	a5,s2,80002320 <waitx+0xda>
        acquire(&np->lock);
    ...
    8000233a:	f74785e3          	beq	a5,s4,800022a4 <waitx+0x5e>
        release(&np->lock);
    ...
    8000234a:	bfd9                	j	80002320 <waitx+0xda>
    if(!havekids || p->killed){
    8000234c:	c701                	beqz	a4,80002354 <waitx+0x10e>
    8000234e:	02892783          	lw	a5,40(s2)
    80002352:	cb8d                	beqz	a5,80002384 <waitx+0x13e>
      release(&wait_lock);
    80002354:	0000f517          	auipc	a0,0xf
    80002358:	a8450513          	addi	a0,a0,-1404 # 80010dd8 <wait_lock>
    ...
    80002368:	60e6                	ld	ra,88(sp)
    8000236a:	6446                	ld	s0,80(sp)
    8000236c:	64a6                	ld	s1,72(sp)
    ...
    8000237e:	6d02                	ld	s10,0(sp)
    80002380:	6125                	addi	sp,sp,96
    80002382:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002384:	85ea                	mv	a1,s10
    80002386:	854a                	mv	a0,s2
    80002388:	00000097          	auipc	ra,0x0
    8000238c:	e5a080e7          	jalr	-422(ra) # 800021e2 <sleep>
    havekids = 0;
    80002390:	b721                	j	80002298 <waitx+0x52>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800023aa:	e4a48493          	addi	s1,s1,-438 # 800111f0 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800023b6:	43e90913          	addi	s2,s2,1086 # 800177f0 <tickslock>
    800023ba:	a811                	j	800023ce <wakeup+0x3c>
      }
      release(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    800023c6:	19848493          	addi	s1,s1,408
    800023ca:	03248663          	beq	s1,s2,800023f6 <wakeup+0x64>
    if(p != myproc()){
    800023ce:	fffff097          	auipc	ra,0xfffff
    800023d2:	5de080e7          	jalr	1502(ra) # 800019ac <myproc>
    800023d6:	fea488e3          	beq	s1,a0,800023c6 <wakeup+0x34>
      acquire(&p->lock);
    ...
    800023e6:	fd379be3          	bne	a5,s3,800023bc <wakeup+0x2a>
    800023ea:	709c                	ld	a5,32(s1)
    800023ec:	fd4798e3          	bne	a5,s4,800023bc <wakeup+0x2a>
        p->state = RUNNABLE;
    800023f0:	0154ac23          	sw	s5,24(s1)
    800023f4:	b7e1                	j	800023bc <wakeup+0x2a>
    }
  }
}
...
0000000080002408 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000241e:	dd648493          	addi	s1,s1,-554 # 800111f0 <proc>
      pp->parent = initproc;
    80002422:	00006a17          	auipc	s4,0x6
    80002426:	726a0a13          	addi	s4,s4,1830 # 80008b48 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    8000242a:	00015997          	auipc	s3,0x15
    8000242e:	3c698993          	addi	s3,s3,966 # 800177f0 <tickslock>
    80002432:	a029                	j	8000243c <reparent+0x34>
    80002434:	19848493          	addi	s1,s1,408
    ...
    80002446:	fc88                	sd	a0,56(s1)
      wakeup(initproc);
    80002448:	00000097          	auipc	ra,0x0
    8000244c:	f4a080e7          	jalr	-182(ra) # 80002392 <wakeup>
...
0000000080002462 <exit>:
{
  ...
  if(p == initproc)
    ...
    80002482:	6ca7b783          	ld	a5,1738(a5) # 80008b48 <initproc>
    80002486:	0d050493          	addi	s1,a0,208
    8000248a:	15050913          	addi	s2,a0,336
    8000248e:	02a79363          	bne	a5,a0,800024b4 <exit+0x52>
    panic("init exiting");
    80002492:	00006517          	auipc	a0,0x6
    80002496:	dce50513          	addi	a0,a0,-562 # 80008260 <digits+0x220>
  ...
  begin_op();
    ...
    800024be:	152080e7          	jalr	338(ra) # 8000460c <begin_op>
  iput(p->cwd);
    800024c2:	1509b503          	ld	a0,336(s3)
    800024c6:	00002097          	auipc	ra,0x2
    800024ca:	93e080e7          	jalr	-1730(ra) # 80003e04 <iput>
  end_op();
    800024ce:	00002097          	auipc	ra,0x2
    800024d2:	1be080e7          	jalr	446(ra) # 8000468c <end_op>
  p->cwd = 0;
    800024d6:	1409b823          	sd	zero,336(s3)
  acquire(&wait_lock);
    800024da:	0000f497          	auipc	s1,0xf
    800024de:	8fe48493          	addi	s1,s1,-1794 # 80010dd8 <wait_lock>
  ...
  wakeup(p->parent);
    800024f6:	0389b503          	ld	a0,56(s3)
    800024fa:	00000097          	auipc	ra,0x0
    800024fe:	e98080e7          	jalr	-360(ra) # 80002392 <wakeup>
  acquire(&p->lock);
    80002502:	854e                	mv	a0,s3
    80002504:	ffffe097          	auipc	ra,0xffffe
    80002508:	6d2080e7          	jalr	1746(ra) # 80000bd6 <acquire>
  p->xstate = status;
    8000250c:	0349a623          	sw	s4,44(s3)
  p->state = ZOMBIE;
    80002510:	4795                	li	a5,5
    80002512:	00f9ac23          	sw	a5,24(s3)
  p->etime = ticks;
    80002516:	00006797          	auipc	a5,0x6
    8000251a:	63a7a783          	lw	a5,1594(a5) # 80008b50 <ticks>
    8000251e:	16f9aa23          	sw	a5,372(s3)
  release(&wait_lock);
  ...
  sched();
    ...
    80002530:	ba4080e7          	jalr	-1116(ra) # 800020d0 <sched>
  panic("zombie exit");
    80002534:	00006517          	auipc	a0,0x6
    80002538:	d3c50513          	addi	a0,a0,-708 # 80008270 <digits+0x230>
    8000253c:	ffffe097          	auipc	ra,0xffffe
    80002540:	002080e7          	jalr	2(ra) # 8000053e <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002558:	c9c48493          	addi	s1,s1,-868 # 800111f0 <proc>
    8000255c:	00015997          	auipc	s3,0x15
    80002560:	29498993          	addi	s3,s3,660 # 800177f0 <tickslock>
    acquire(&p->lock);
    80002564:	8526                	mv	a0,s1
    80002566:	ffffe097          	auipc	ra,0xffffe
    8000256a:	670080e7          	jalr	1648(ra) # 80000bd6 <acquire>
    if(p->pid == pid){
    ...
    8000257a:	714080e7          	jalr	1812(ra) # 80000c8a <release>
  for(p = proc; p < &proc[NPROC]; p++){
...
setkilled(struct proc *p)
{
  ...
  acquire(&p->lock);
    ...
    800025c6:	614080e7          	jalr	1556(ra) # 80000bd6 <acquire>
  p->killed = 1;
...
0000000080002614 <wait>:
{
  ...
  struct proc *p = myproc();
    ...
    80002632:	37e080e7          	jalr	894(ra) # 800019ac <myproc>
    80002636:	892a                	mv	s2,a0
  acquire(&wait_lock);
    80002638:	0000e517          	auipc	a0,0xe
    8000263c:	7a050513          	addi	a0,a0,1952 # 80010dd8 <wait_lock>
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++){
    8000264e:	00015997          	auipc	s3,0x15
    80002652:	1a298993          	addi	s3,s3,418 # 800177f0 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002656:	0000ec17          	auipc	s8,0xe
    8000265a:	782c0c13          	addi	s8,s8,1922 # 80010dd8 <wait_lock>
    havekids = 0;
    8000265e:	875e                	mv	a4,s7
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002660:	0000f497          	auipc	s1,0xf
    80002664:	b9048493          	addi	s1,s1,-1136 # 800111f0 <proc>
    80002668:	a0bd                	j	800026d6 <wait+0xc2>
          pid = pp->pid;
    8000266a:	0304a983          	lw	s3,48(s1)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    8000266e:	000b0e63          	beqz	s6,8000268a <wait+0x76>
    80002672:	4691                	li	a3,4
    80002674:	02c48613          	addi	a2,s1,44
    80002678:	85da                	mv	a1,s6
    8000267a:	05093503          	ld	a0,80(s2)
    8000267e:	fffff097          	auipc	ra,0xfffff
    80002682:	fea080e7          	jalr	-22(ra) # 80001668 <copyout>
    80002686:	02054563          	bltz	a0,800026b0 <wait+0x9c>
          freeproc(pp);
    8000268a:	8526                	mv	a0,s1
    8000268c:	fffff097          	auipc	ra,0xfffff
    80002690:	4d2080e7          	jalr	1234(ra) # 80001b5e <freeproc>
          release(&pp->lock);
    ...
    800026a2:	73a50513          	addi	a0,a0,1850 # 80010dd8 <wait_lock>
    800026a6:	ffffe097          	auipc	ra,0xffffe
    800026aa:	5e4080e7          	jalr	1508(ra) # 80000c8a <release>
          return pid;
    800026ae:	a0b5                	j	8000271a <wait+0x106>
            release(&pp->lock);
    ...
    800026be:	71e50513          	addi	a0,a0,1822 # 80010dd8 <wait_lock>
    800026c2:	ffffe097          	auipc	ra,0xffffe
    800026c6:	5c8080e7          	jalr	1480(ra) # 80000c8a <release>
            return -1;
    800026ca:	59fd                	li	s3,-1
    800026cc:	a0b9                	j	8000271a <wait+0x106>
    for(pp = proc; pp < &proc[NPROC]; pp++){
    800026ce:	19848493          	addi	s1,s1,408
    800026d2:	03348463          	beq	s1,s3,800026fa <wait+0xe6>
      if(pp->parent == p){
    800026d6:	7c9c                	ld	a5,56(s1)
    800026d8:	ff279be3          	bne	a5,s2,800026ce <wait+0xba>
        acquire(&pp->lock);
    800026dc:	8526                	mv	a0,s1
    800026de:	ffffe097          	auipc	ra,0xffffe
    800026e2:	4f8080e7          	jalr	1272(ra) # 80000bd6 <acquire>
        if(pp->state == ZOMBIE){
    800026e6:	4c9c                	lw	a5,24(s1)
    800026e8:	f94781e3          	beq	a5,s4,8000266a <wait+0x56>
        release(&pp->lock);
    ...
    800026f8:	bfd9                	j	800026ce <wait+0xba>
    if(!havekids || killed(p)){
    800026fa:	c719                	beqz	a4,80002708 <wait+0xf4>
    800026fc:	854a                	mv	a0,s2
    800026fe:	00000097          	auipc	ra,0x0
    80002702:	ee4080e7          	jalr	-284(ra) # 800025e2 <killed>
    80002706:	c51d                	beqz	a0,80002734 <wait+0x120>
      release(&wait_lock);
    80002708:	0000e517          	auipc	a0,0xe
    8000270c:	6d050513          	addi	a0,a0,1744 # 80010dd8 <wait_lock>
    ...
    8000272e:	6c02                	ld	s8,0(sp)
    80002730:	6161                	addi	sp,sp,80
    80002732:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002734:	85e2                	mv	a1,s8
    80002736:	854a                	mv	a0,s2
    80002738:	00000097          	auipc	ra,0x0
    8000273c:	aaa080e7          	jalr	-1366(ra) # 800021e2 <sleep>
    havekids = 0;
    80002740:	bf39                	j	8000265e <wait+0x4a>
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  if(user_dst){
    ...
    80002770:	efc080e7          	jalr	-260(ra) # 80001668 <copyout>
  } else {
    ...
    80002790:	5a2080e7          	jalr	1442(ra) # 80000d2e <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    800027b4:	1fc080e7          	jalr	508(ra) # 800019ac <myproc>
  if(user_src){
    ...
    800027c6:	f32080e7          	jalr	-206(ra) # 800016f4 <copyin>
  } else {
    ...
    800027e6:	54c080e7          	jalr	1356(ra) # 80000d2e <memmove>
    return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80002808:	8c450513          	addi	a0,a0,-1852 # 800080c8 <digits+0x88>
    8000280c:	ffffe097          	auipc	ra,0xffffe
    80002810:	d7c080e7          	jalr	-644(ra) # 80000588 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    80002814:	0000f497          	auipc	s1,0xf
    80002818:	b3448493          	addi	s1,s1,-1228 # 80011348 <proc+0x158>
    8000281c:	00015917          	auipc	s2,0x15
    80002820:	12c90913          	addi	s2,s2,300 # 80017948 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    80002824:	4b15                	li	s6,5
      state = states[p->state];
    else
      state = "???";
    80002826:	00006997          	auipc	s3,0x6
    8000282a:	a5a98993          	addi	s3,s3,-1446 # 80008280 <digits+0x240>
    printf("%d %s %d %d %d %s", p->pid, state,p->ctime,p->rtime,p->etime, p->name);
    8000282e:	00006a97          	auipc	s5,0x6
    80002832:	a5aa8a93          	addi	s5,s5,-1446 # 80008288 <digits+0x248>
    printf("\n");
    80002836:	00006a17          	auipc	s4,0x6
    8000283a:	892a0a13          	addi	s4,s4,-1902 # 800080c8 <digits+0x88>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    8000283e:	00006b97          	auipc	s7,0x6
    80002842:	a92b8b93          	addi	s7,s7,-1390 # 800082d0 <states.0>
    80002846:	a03d                	j	80002874 <procdump+0x86>
    printf("%d %s %d %d %d %s", p->pid, state,p->ctime,p->rtime,p->etime, p->name);
    80002848:	01c82783          	lw	a5,28(a6)
    8000284c:	01482703          	lw	a4,20(a6)
    80002850:	01882683          	lw	a3,24(a6)
    80002854:	ed882583          	lw	a1,-296(a6)
    80002858:	8556                	mv	a0,s5
    8000285a:	ffffe097          	auipc	ra,0xffffe
    8000285e:	d2e080e7          	jalr	-722(ra) # 80000588 <printf>
    printf("\n");
    80002862:	8552                	mv	a0,s4
    80002864:	ffffe097          	auipc	ra,0xffffe
    80002868:	d24080e7          	jalr	-732(ra) # 80000588 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    8000286c:	19848493          	addi	s1,s1,408
    80002870:	03248163          	beq	s1,s2,80002892 <procdump+0xa4>
    if(p->state == UNUSED)
    80002874:	8826                	mv	a6,s1
    80002876:	ec04a783          	lw	a5,-320(s1)
    8000287a:	dbed                	beqz	a5,8000286c <procdump+0x7e>
      state = "???";
    8000287c:	864e                	mv	a2,s3
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    8000287e:	fcfb65e3          	bltu	s6,a5,80002848 <procdump+0x5a>
    80002882:	1782                	slli	a5,a5,0x20
    80002884:	9381                	srli	a5,a5,0x20
    80002886:	078e                	slli	a5,a5,0x3
    80002888:	97de                	add	a5,a5,s7
    8000288a:	6390                	ld	a2,0(a5)
    8000288c:	fe55                	bnez	a2,80002848 <procdump+0x5a>
      state = "???";
    8000288e:	864e                	mv	a2,s3
    80002890:	bf65                	j	80002848 <procdump+0x5a>
  }
}
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    8000291e:	9e658593          	addi	a1,a1,-1562 # 80008300 <states.0+0x30>
    80002922:	00015517          	auipc	a0,0x15
    80002926:	ece50513          	addi	a0,a0,-306 # 800177f0 <tickslock>
    8000292a:	ffffe097          	auipc	ra,0xffffe
    8000292e:	21c080e7          	jalr	540(ra) # 80000b46 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002944:	7e078793          	addi	a5,a5,2016 # 80006120 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    8000295e:	052080e7          	jalr	82(ra) # 800019ac <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
...
clockintr()
{
  ...
  acquire(&tickslock);
    800029f4:	00015917          	auipc	s2,0x15
    800029f8:	dfc90913          	addi	s2,s2,-516 # 800177f0 <tickslock>
    800029fc:	854a                	mv	a0,s2
    800029fe:	ffffe097          	auipc	ra,0xffffe
    80002a02:	1d8080e7          	jalr	472(ra) # 80000bd6 <acquire>
  ticks++;
    80002a06:	00006497          	auipc	s1,0x6
    80002a0a:	14a48493          	addi	s1,s1,330 # 80008b50 <ticks>
    80002a0e:	409c                	lw	a5,0(s1)
    80002a10:	2785                	addiw	a5,a5,1
    80002a12:	c09c                	sw	a5,0(s1)
  update_time();
    80002a14:	fffff097          	auipc	ra,0xfffff
    80002a18:	4bc080e7          	jalr	1212(ra) # 80001ed0 <update_time>
  wakeup(&ticks);
    80002a1c:	8526                	mv	a0,s1
    80002a1e:	00000097          	auipc	ra,0x0
    80002a22:	974080e7          	jalr	-1676(ra) # 80002392 <wakeup>
  release(&tickslock);
    80002a26:	854a                	mv	a0,s2
    80002a28:	ffffe097          	auipc	ra,0xffffe
    80002a2c:	262080e7          	jalr	610(ra) # 80000c8a <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002a72:	7ba080e7          	jalr	1978(ra) # 80006228 <plic_claim>
    ...
    80002a8e:	87e50513          	addi	a0,a0,-1922 # 80008308 <states.0+0x38>
...
0000000080002ade <usertrap>:
{
  ...
  if((r_sstatus() & SSTATUS_SPP) != 0)
    ...
    80002af2:	efb9                	bnez	a5,80002b50 <usertrap+0x72>
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002af4:	00003797          	auipc	a5,0x3
    80002af8:	62c78793          	addi	a5,a5,1580 # 80006120 <kernelvec>
    80002afc:	10579073          	csrw	stvec,a5
  struct proc *p = myproc();
    80002b00:	fffff097          	auipc	ra,0xfffff
    80002b04:	eac080e7          	jalr	-340(ra) # 800019ac <myproc>
  ...
  if(r_scause() == 8){
    ...
    80002b18:	04f70463          	beq	a4,a5,80002b60 <usertrap+0x82>
  } else if((which_dev = devintr()) != 0){
    80002b1c:	00000097          	auipc	ra,0x0
    80002b20:	f20080e7          	jalr	-224(ra) # 80002a3c <devintr>
    80002b24:	892a                	mv	s2,a0
    80002b26:	c16d                	beqz	a0,80002c08 <usertrap+0x12a>
    if(which_dev == 2){
    80002b28:	4789                	li	a5,2
    80002b2a:	06f50663          	beq	a0,a5,80002b96 <usertrap+0xb8>
  if(killed(p))
    80002b2e:	8526                	mv	a0,s1
    80002b30:	00000097          	auipc	ra,0x0
    80002b34:	ab2080e7          	jalr	-1358(ra) # 800025e2 <killed>
    80002b38:	10051563          	bnez	a0,80002c42 <usertrap+0x164>
  usertrapret();
    80002b3c:	00000097          	auipc	ra,0x0
    80002b40:	e16080e7          	jalr	-490(ra) # 80002952 <usertrapret>
}
    ...
    80002b54:	7d850513          	addi	a0,a0,2008 # 80008328 <states.0+0x58>
    80002b58:	ffffe097          	auipc	ra,0xffffe
    80002b5c:	9e6080e7          	jalr	-1562(ra) # 8000053e <panic>
    if(killed(p))
    80002b60:	00000097          	auipc	ra,0x0
    80002b64:	a82080e7          	jalr	-1406(ra) # 800025e2 <killed>
    80002b68:	e10d                	bnez	a0,80002b8a <usertrap+0xac>
    p->trapframe->epc += 4;
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002b82:	328080e7          	jalr	808(ra) # 80002ea6 <syscall>
  int which_dev = 0;
    80002b86:	4901                	li	s2,0
    80002b88:	b75d                	j	80002b2e <usertrap+0x50>
      exit(-1);
    80002b8a:	557d                	li	a0,-1
    80002b8c:	00000097          	auipc	ra,0x0
    80002b90:	8d6080e7          	jalr	-1834(ra) # 80002462 <exit>
    80002b94:	bfd9                	j	80002b6a <usertrap+0x8c>
      acquire(&p->lock);
    80002b96:	8526                	mv	a0,s1
    80002b98:	ffffe097          	auipc	ra,0xffffe
    80002b9c:	03e080e7          	jalr	62(ra) # 80000bd6 <acquire>
      if (p->state == RUNNING)
    80002ba0:	4c98                	lw	a4,24(s1)
    80002ba2:	4791                	li	a5,4
    80002ba4:	02f70363          	beq	a4,a5,80002bca <usertrap+0xec>
      release(&p->lock);
    80002ba8:	8526                	mv	a0,s1
    80002baa:	ffffe097          	auipc	ra,0xffffe
    80002bae:	0e0080e7          	jalr	224(ra) # 80000c8a <release>
  if(killed(p))
    80002bb2:	8526                	mv	a0,s1
    80002bb4:	00000097          	auipc	ra,0x0
    80002bb8:	a2e080e7          	jalr	-1490(ra) # 800025e2 <killed>
    80002bbc:	c959                	beqz	a0,80002c52 <usertrap+0x174>
    exit(-1);
    80002bbe:	557d                	li	a0,-1
    80002bc0:	00000097          	auipc	ra,0x0
    80002bc4:	8a2080e7          	jalr	-1886(ra) # 80002462 <exit>
  if(which_dev == 2)
    80002bc8:	a069                	j	80002c52 <usertrap+0x174>
        p->alarmdata.currticks++;
    80002bca:	1784a783          	lw	a5,376(s1)
    80002bce:	2785                	addiw	a5,a5,1
    80002bd0:	16f4ac23          	sw	a5,376(s1)
        if (p->alarmdata.nticks != 0 && p->alarmdata.currticks % p->alarmdata.nticks == 0 && p->alarmdata.trapframe_cpy == 0)
    80002bd4:	17c4a703          	lw	a4,380(s1)
    80002bd8:	db61                	beqz	a4,80002ba8 <usertrap+0xca>
    80002bda:	02e7e7bb          	remw	a5,a5,a4
    80002bde:	f7e9                	bnez	a5,80002ba8 <usertrap+0xca>
    80002be0:	1884b783          	ld	a5,392(s1)
    80002be4:	f3f1                	bnez	a5,80002ba8 <usertrap+0xca>
          p->alarmdata.trapframe_cpy = kalloc();
    80002be6:	ffffe097          	auipc	ra,0xffffe
    80002bea:	f00080e7          	jalr	-256(ra) # 80000ae6 <kalloc>
    80002bee:	18a4b423          	sd	a0,392(s1)
          memmove(p->alarmdata.trapframe_cpy, p->trapframe, PGSIZE);
    80002bf2:	6605                	lui	a2,0x1
    80002bf4:	6cac                	ld	a1,88(s1)
    80002bf6:	ffffe097          	auipc	ra,0xffffe
    80002bfa:	138080e7          	jalr	312(ra) # 80000d2e <memmove>
          p->trapframe->epc = p->alarmdata.handlerfn;
    80002bfe:	6cbc                	ld	a5,88(s1)
    80002c00:	1804b703          	ld	a4,384(s1)
    80002c04:	ef98                	sd	a4,24(a5)
    80002c06:	b74d                	j	80002ba8 <usertrap+0xca>
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002c08:	142025f3          	csrr	a1,scause
    printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    80002c0c:	5890                	lw	a2,48(s1)
    80002c0e:	00005517          	auipc	a0,0x5
    80002c12:	73a50513          	addi	a0,a0,1850 # 80008348 <states.0+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002c2a:	75250513          	addi	a0,a0,1874 # 80008378 <states.0+0xa8>
    80002c2e:	ffffe097          	auipc	ra,0xffffe
    80002c32:	95a080e7          	jalr	-1702(ra) # 80000588 <printf>
    setkilled(p);
    80002c36:	8526                	mv	a0,s1
    80002c38:	00000097          	auipc	ra,0x0
    80002c3c:	97e080e7          	jalr	-1666(ra) # 800025b6 <setkilled>
    80002c40:	b5fd                	j	80002b2e <usertrap+0x50>
    exit(-1);
    80002c42:	557d                	li	a0,-1
    80002c44:	00000097          	auipc	ra,0x0
    80002c48:	81e080e7          	jalr	-2018(ra) # 80002462 <exit>
  if(which_dev == 2)
    80002c4c:	4789                	li	a5,2
    80002c4e:	eef917e3          	bne	s2,a5,80002b3c <usertrap+0x5e>
    yield();
    80002c52:	fffff097          	auipc	ra,0xfffff
    80002c56:	554080e7          	jalr	1364(ra) # 800021a6 <yield>
    80002c5a:	b5cd                	j	80002b3c <usertrap+0x5e>
...
0000000080002c5c <kerneltrap>:
{
  ...
  if((sstatus & SSTATUS_SPP) == 0)
    ...
    80002c7a:	cb85                	beqz	a5,80002caa <kerneltrap+0x4e>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002c7c:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002c80:	8b89                	andi	a5,a5,2
  if(intr_get() != 0)
    80002c82:	ef85                	bnez	a5,80002cba <kerneltrap+0x5e>
  if((which_dev = devintr()) == 0){
    80002c84:	00000097          	auipc	ra,0x0
    80002c88:	db8080e7          	jalr	-584(ra) # 80002a3c <devintr>
    80002c8c:	cd1d                	beqz	a0,80002cca <kerneltrap+0x6e>
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002c8e:	4789                	li	a5,2
    80002c90:	06f50a63          	beq	a0,a5,80002d04 <kerneltrap+0xa8>
  asm volatile("csrw sepc, %0" : : "r" (x));
    80002c94:	14191073          	csrw	sepc,s2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002c98:	10049073          	csrw	sstatus,s1
}
    ...
    80002cae:	6ee50513          	addi	a0,a0,1774 # 80008398 <states.0+0xc8>
    80002cb2:	ffffe097          	auipc	ra,0xffffe
    80002cb6:	88c080e7          	jalr	-1908(ra) # 8000053e <panic>
    panic("kerneltrap: interrupts enabled");
    80002cba:	00005517          	auipc	a0,0x5
    80002cbe:	70650513          	addi	a0,a0,1798 # 800083c0 <states.0+0xf0>
    80002cc2:	ffffe097          	auipc	ra,0xffffe
    80002cc6:	87c080e7          	jalr	-1924(ra) # 8000053e <panic>
    printf("scause %p\n", scause);
    80002cca:	85ce                	mv	a1,s3
    80002ccc:	00005517          	auipc	a0,0x5
    80002cd0:	71450513          	addi	a0,a0,1812 # 800083e0 <states.0+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002ce8:	70c50513          	addi	a0,a0,1804 # 800083f0 <states.0+0x120>
    80002cec:	ffffe097          	auipc	ra,0xffffe
    80002cf0:	89c080e7          	jalr	-1892(ra) # 80000588 <printf>
    panic("kerneltrap");
    80002cf4:	00005517          	auipc	a0,0x5
    80002cf8:	71450513          	addi	a0,a0,1812 # 80008408 <states.0+0x138>
  ...
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    80002d0c:	d541                	beqz	a0,80002c94 <kerneltrap+0x38>
    80002d0e:	fffff097          	auipc	ra,0xfffff
    80002d12:	c9e080e7          	jalr	-866(ra) # 800019ac <myproc>
    80002d16:	4d18                	lw	a4,24(a0)
    80002d18:	4791                	li	a5,4
    80002d1a:	f6f71de3          	bne	a4,a5,80002c94 <kerneltrap+0x38>
    yield();
    80002d1e:	fffff097          	auipc	ra,0xfffff
    80002d22:	488080e7          	jalr	1160(ra) # 800021a6 <yield>
    80002d26:	b7bd                	j	80002c94 <kerneltrap+0x38>
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    ...
    80002d38:	c78080e7          	jalr	-904(ra) # 800019ac <myproc>
  switch (n) {
    80002d3c:	4795                	li	a5,5
    80002d3e:	0497e163          	bltu	a5,s1,80002d80 <argraw+0x58>
    80002d42:	048a                	slli	s1,s1,0x2
    80002d44:	00006717          	auipc	a4,0x6
    80002d48:	80c70713          	addi	a4,a4,-2036 # 80008550 <states.0+0x280>
  ...
  panic("argraw");
    ...
    80002d84:	69850513          	addi	a0,a0,1688 # 80008418 <states.0+0x148>
...
0000000080002d90 <fetchaddr>:
{
  ...
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    ...
    80002dc2:	936080e7          	jalr	-1738(ra) # 800016f4 <copyin>
...
0000000080002de2 <fetchstr>:
{
  ...
  if(copyinstr(p->pagetable, buf, addr, max) < 0)
    ...
    80002e0a:	97c080e7          	jalr	-1668(ra) # 80001782 <copyinstr>
    80002e0e:	00054e63          	bltz	a0,80002e2a <fetchstr+0x48>
  return strlen(buf);
    80002e12:	8526                	mv	a0,s1
    80002e14:	ffffe097          	auipc	ra,0xffffe
    80002e18:	03a080e7          	jalr	58(ra) # 80000e4e <strlen>
}
    ...
    80002e2c:	bfc5                	j	80002e1c <fetchstr+0x3a>

0000000080002e2e <argint>:
...
argint(int n, int *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002e3e:	eee080e7          	jalr	-274(ra) # 80002d28 <argraw>
    80002e42:	c088                	sw	a0,0(s1)
}
...
argaddr(int n, uint64 *ip)
{
    ...
    80002e58:	84ae                	mv	s1,a1
  *ip = argraw(n);
    80002e5a:	00000097          	auipc	ra,0x0
    80002e5e:	ece080e7          	jalr	-306(ra) # 80002d28 <argraw>
    80002e62:	e088                	sd	a0,0(s1)
}
...
argstr(int n, char *buf, int max)
{
  ...
  uint64 addr;
  argaddr(n, &addr);
    80002e7e:	fd840593          	addi	a1,s0,-40
    80002e82:	00000097          	auipc	ra,0x0
    80002e86:	fcc080e7          	jalr	-52(ra) # 80002e4e <argaddr>
  return fetchstr(addr, buf, max);
    80002e8a:	864a                	mv	a2,s2
    80002e8c:	85a6                	mv	a1,s1
    80002e8e:	fd843503          	ld	a0,-40(s0)
    80002e92:	00000097          	auipc	ra,0x0
    80002e96:	f50080e7          	jalr	-176(ra) # 80002de2 <fetchstr>
}
...
syscall(void)
{
    ...
    80002eb2:	e852                	sd	s4,16(sp)
    80002eb4:	0080                	addi	s0,sp,64
  int num;
  struct proc *p = myproc();
  ...
  num = p->trapframe->a7;
    ...
    80002ec2:	77dc                	ld	a5,168(a5)
    80002ec4:	0007899b          	sext.w	s3,a5
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002ec8:	37fd                	addiw	a5,a5,-1
    80002eca:	4765                	li	a4,25
    80002ecc:	0cf76863          	bltu	a4,a5,80002f9c <syscall+0xf6>
    80002ed0:	00399713          	slli	a4,s3,0x3
    80002ed4:	00005797          	auipc	a5,0x5
    80002ed8:	69478793          	addi	a5,a5,1684 # 80008568 <syscalls>
    80002edc:	97ba                	add	a5,a5,a4
    80002ede:	0007b903          	ld	s2,0(a5)
    80002ee2:	0a090d63          	beqz	s2,80002f9c <syscall+0xf6>
    // since p->trapframe->a0 will get filled with return value of systemcall,
    // copy its value to come other variable
    int a0copy;
    argint(0,&a0copy);  
    80002ee6:	fc840593          	addi	a1,s0,-56
    80002eea:	4501                	li	a0,0
    80002eec:	00000097          	auipc	ra,0x0
    80002ef0:	f42080e7          	jalr	-190(ra) # 80002e2e <argint>

    // Use num to lookup the system call function for num, call it,
    // and store its return value in p->trapframe->a0
    p->trapframe->a0 = syscalls[num]();
    80002ef4:	0584ba03          	ld	s4,88(s1)
    80002ef8:	9902                	jalr	s2
    80002efa:	06aa3823          	sd	a0,112(s4)

    if((p->syscall_tracebits) & (1 << num)){ // is the syscall depicted by num asked to be traced.
    80002efe:	1684a783          	lw	a5,360(s1)
    80002f02:	4137d7bb          	sraw	a5,a5,s3
    80002f06:	8b85                	andi	a5,a5,1
    80002f08:	cbcd                	beqz	a5,80002fba <syscall+0x114>
      printf("%d: syscall %s ( ",p->pid,syscalls_names[num]);
    80002f0a:	00006917          	auipc	s2,0x6
    80002f0e:	ace90913          	addi	s2,s2,-1330 # 800089d8 <syscalls_names>
    80002f12:	00399793          	slli	a5,s3,0x3
    80002f16:	97ca                	add	a5,a5,s2
    80002f18:	6390                	ld	a2,0(a5)
    80002f1a:	588c                	lw	a1,48(s1)
    80002f1c:	00005517          	auipc	a0,0x5
    80002f20:	50450513          	addi	a0,a0,1284 # 80008420 <states.0+0x150>
    80002f24:	ffffd097          	auipc	ra,0xffffd
    80002f28:	664080e7          	jalr	1636(ra) # 80000588 <printf>
      for(int argcnt = 0; argcnt<syscalls_argcnt[num];argcnt++){
    80002f2c:	00299793          	slli	a5,s3,0x2
    80002f30:	993e                	add	s2,s2,a5
    80002f32:	0d892783          	lw	a5,216(s2)
    80002f36:	04f05863          	blez	a5,80002f86 <syscall+0xe0>
    ...
    80002f40:	4fca0a13          	addi	s4,s4,1276 # 80008438 <states.0+0x168>
      for(int argcnt = 0; argcnt<syscalls_argcnt[num];argcnt++){
    80002f44:	098a                	slli	s3,s3,0x2
    80002f46:	00006797          	auipc	a5,0x6
    80002f4a:	a9278793          	addi	a5,a5,-1390 # 800089d8 <syscalls_names>
    80002f4e:	99be                	add	s3,s3,a5
    80002f50:	a00d                	j	80002f72 <syscall+0xcc>
          temp = a0copy;
    80002f52:	fc842783          	lw	a5,-56(s0)
    80002f56:	fcf42623          	sw	a5,-52(s0)
        printf("%d ",temp);
    80002f5a:	fcc42583          	lw	a1,-52(s0)
    80002f5e:	8552                	mv	a0,s4
    80002f60:	ffffd097          	auipc	ra,0xffffd
    80002f64:	628080e7          	jalr	1576(ra) # 80000588 <printf>
      for(int argcnt = 0; argcnt<syscalls_argcnt[num];argcnt++){
    80002f68:	2905                	addiw	s2,s2,1
    80002f6a:	0d89a783          	lw	a5,216(s3)
    80002f6e:	00f95c63          	bge	s2,a5,80002f86 <syscall+0xe0>
        if(argcnt != 0){
    80002f72:	fe0900e3          	beqz	s2,80002f52 <syscall+0xac>
          argint(argcnt,&temp);
    80002f76:	fcc40593          	addi	a1,s0,-52
    80002f7a:	854a                	mv	a0,s2
    80002f7c:	00000097          	auipc	ra,0x0
    80002f80:	eb2080e7          	jalr	-334(ra) # 80002e2e <argint>
    80002f84:	bfd9                	j	80002f5a <syscall+0xb4>
      }
      printf(") -> %d\n",p->trapframe->a0);
    80002f86:	6cbc                	ld	a5,88(s1)
    80002f88:	7bac                	ld	a1,112(a5)
    80002f8a:	00005517          	auipc	a0,0x5
    80002f8e:	4b650513          	addi	a0,a0,1206 # 80008440 <states.0+0x170>
    80002f92:	ffffd097          	auipc	ra,0xffffd
    80002f96:	5f6080e7          	jalr	1526(ra) # 80000588 <printf>
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002f9a:	a005                	j	80002fba <syscall+0x114>
    }
  } else {
    printf("%d %s: unknown sys call %d\n",
    80002f9c:	86ce                	mv	a3,s3
    80002f9e:	15848613          	addi	a2,s1,344
    80002fa2:	588c                	lw	a1,48(s1)
    80002fa4:	00005517          	auipc	a0,0x5
    80002fa8:	4ac50513          	addi	a0,a0,1196 # 80008450 <states.0+0x180>
    80002fac:	ffffd097          	auipc	ra,0xffffd
    80002fb0:	5dc080e7          	jalr	1500(ra) # 80000588 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
    80002fb4:	6cbc                	ld	a5,88(s1)
...
sys_exit(void)
{
  ...
  argint(0, &n);
    ...
    80002fdc:	e56080e7          	jalr	-426(ra) # 80002e2e <argint>
  exit(n);
    80002fe0:	fec42503          	lw	a0,-20(s0)
    80002fe4:	fffff097          	auipc	ra,0xfffff
    80002fe8:	47e080e7          	jalr	1150(ra) # 80002462 <exit>
...
sys_fork(void)
{
  ...
  return fork();
    ...
    8000301c:	d70080e7          	jalr	-656(ra) # 80001d88 <fork>
}
...
sys_wait(void)
{
  ...
  argaddr(0, &p);
    ...
    8000303a:	e18080e7          	jalr	-488(ra) # 80002e4e <argaddr>
  return wait(p);
    8000303e:	fe843503          	ld	a0,-24(s0)
    80003042:	fffff097          	auipc	ra,0xfffff
    80003046:	5d2080e7          	jalr	1490(ra) # 80002614 <wait>
}
...
sys_sbrk(void)
{
  ...
  argint(0, &n);
    ...
    80003066:	dcc080e7          	jalr	-564(ra) # 80002e2e <argint>
  addr = myproc()->sz;
    8000306a:	fffff097          	auipc	ra,0xfffff
    8000306e:	942080e7          	jalr	-1726(ra) # 800019ac <myproc>
    80003072:	6524                	ld	s1,72(a0)
  if(growproc(n) < 0)
    80003074:	fdc42503          	lw	a0,-36(s0)
    80003078:	fffff097          	auipc	ra,0xfffff
    8000307c:	cb4080e7          	jalr	-844(ra) # 80001d2c <growproc>
    80003080:	00054863          	bltz	a0,80003090 <sys_sbrk+0x3e>
    return -1;
  return addr;
}
    ...
    8000308e:	8082                	ret
    return -1;
    80003090:	54fd                	li	s1,-1
    80003092:	bfcd                	j	80003084 <sys_sbrk+0x32>

0000000080003094 <sys_sleep>:
...
sys_sleep(void)
{
  ...
  argint(0, &n);
    ...
    800030ac:	d86080e7          	jalr	-634(ra) # 80002e2e <argint>
  acquire(&tickslock);
    800030b0:	00014517          	auipc	a0,0x14
    800030b4:	74050513          	addi	a0,a0,1856 # 800177f0 <tickslock>
    800030b8:	ffffe097          	auipc	ra,0xffffe
    800030bc:	b1e080e7          	jalr	-1250(ra) # 80000bd6 <acquire>
  ticks0 = ticks;
    800030c0:	00006917          	auipc	s2,0x6
    800030c4:	a9092903          	lw	s2,-1392(s2) # 80008b50 <ticks>
  while(ticks - ticks0 < n){
    800030c8:	fcc42783          	lw	a5,-52(s0)
    800030cc:	cf9d                	beqz	a5,8000310a <sys_sleep+0x76>
    if(killed(myproc())){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
    800030ce:	00014997          	auipc	s3,0x14
    800030d2:	72298993          	addi	s3,s3,1826 # 800177f0 <tickslock>
    800030d6:	00006497          	auipc	s1,0x6
    800030da:	a7a48493          	addi	s1,s1,-1414 # 80008b50 <ticks>
    if(killed(myproc())){
    800030de:	fffff097          	auipc	ra,0xfffff
    800030e2:	8ce080e7          	jalr	-1842(ra) # 800019ac <myproc>
    800030e6:	fffff097          	auipc	ra,0xfffff
    800030ea:	4fc080e7          	jalr	1276(ra) # 800025e2 <killed>
    800030ee:	ed15                	bnez	a0,8000312a <sys_sleep+0x96>
    sleep(&ticks, &tickslock);
    800030f0:	85ce                	mv	a1,s3
    800030f2:	8526                	mv	a0,s1
    800030f4:	fffff097          	auipc	ra,0xfffff
    800030f8:	0ee080e7          	jalr	238(ra) # 800021e2 <sleep>
  while(ticks - ticks0 < n){
    800030fc:	409c                	lw	a5,0(s1)
    800030fe:	412787bb          	subw	a5,a5,s2
    80003102:	fcc42703          	lw	a4,-52(s0)
    80003106:	fce7ece3          	bltu	a5,a4,800030de <sys_sleep+0x4a>
  }
  release(&tickslock);
    8000310a:	00014517          	auipc	a0,0x14
    8000310e:	6e650513          	addi	a0,a0,1766 # 800177f0 <tickslock>
  ...
  return 0;
    ...
    8000312e:	6c650513          	addi	a0,a0,1734 # 800177f0 <tickslock>
    80003132:	ffffe097          	auipc	ra,0xffffe
    80003136:	b58080e7          	jalr	-1192(ra) # 80000c8a <release>
      return -1;
    8000313a:	557d                	li	a0,-1
    8000313c:	b7c5                	j	8000311c <sys_sleep+0x88>

000000008000313e <sys_kill>:
...
sys_kill(void)
{
  ...
  argint(0, &pid);
    ...
    80003150:	ce2080e7          	jalr	-798(ra) # 80002e2e <argint>
  return kill(pid);
    80003154:	fec42503          	lw	a0,-20(s0)
    80003158:	fffff097          	auipc	ra,0xfffff
    8000315c:	3ec080e7          	jalr	1004(ra) # 80002544 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80003176:	67e50513          	addi	a0,a0,1662 # 800177f0 <tickslock>
    8000317a:	ffffe097          	auipc	ra,0xffffe
    8000317e:	a5c080e7          	jalr	-1444(ra) # 80000bd6 <acquire>
  xticks = ticks;
    80003182:	00006497          	auipc	s1,0x6
    80003186:	9ce4a483          	lw	s1,-1586(s1) # 80008b50 <ticks>
  release(&tickslock);
    8000318a:	00014517          	auipc	a0,0x14
    8000318e:	66650513          	addi	a0,a0,1638 # 800177f0 <tickslock>
    80003192:	ffffe097          	auipc	ra,0xffffe
    80003196:	af8080e7          	jalr	-1288(ra) # 80000c8a <release>
  return xticks;
}
    8000319a:	02049513          	slli	a0,s1,0x20
    8000319e:	9101                	srli	a0,a0,0x20
...
sys_trace(void)
{
  ...
  struct proc *p = myproc();
    ...
    800031b8:	7f8080e7          	jalr	2040(ra) # 800019ac <myproc>
  ...
  argint(0, &(p->syscall_tracebits));
    800031c6:	16848593          	addi	a1,s1,360
    800031ca:	4501                	li	a0,0
    800031cc:	00000097          	auipc	ra,0x0
    800031d0:	c62080e7          	jalr	-926(ra) # 80002e2e <argint>
  release(&p->lock);
  ...
  if (p->syscall_tracebits < 0)
    800031de:	1684a503          	lw	a0,360(s1)
    return -1;
  return 0;
}
    800031e2:	957d                	srai	a0,a0,0x3f
...
sys_sigalarm()
{
  ...
  struct proc *p = myproc();
    ...
    800031fc:	7b4080e7          	jalr	1972(ra) # 800019ac <myproc>
  ...
  argint(0,&(p->alarmdata.nticks)); // p->alarmdata.nticks = n 
    8000320a:	17c48593          	addi	a1,s1,380
    8000320e:	4501                	li	a0,0
    80003210:	00000097          	auipc	ra,0x0
    80003214:	c1e080e7          	jalr	-994(ra) # 80002e2e <argint>
  if(p->alarmdata.nticks < 0){      // error handling
    80003218:	17c4a783          	lw	a5,380(s1)
    8000321c:	0207c463          	bltz	a5,80003244 <sys_sigalarm+0x56>
    release(&p->lock);
    return -1;
  }
  argaddr(1,&(p->alarmdata.handlerfn));   // p->alarmdata.handlerfn = fn
    80003220:	18048593          	addi	a1,s1,384
    80003224:	4505                	li	a0,1
    80003226:	00000097          	auipc	ra,0x0
    8000322a:	c28080e7          	jalr	-984(ra) # 80002e4e <argaddr>
  ...
  return 0;
    ...
    80003250:	b7ed                	j	8000323a <sys_sigalarm+0x4c>

0000000080003252 <sys_sigreturn>:
...
sys_sigreturn()
{
  ...
  struct proc *p = myproc();
    ...
    80003260:	750080e7          	jalr	1872(ra) # 800019ac <myproc>
  ...
  memmove(p->trapframe,p->alarmdata.trapframe_cpy,PGSIZE); // restore original state
    8000326e:	6605                	lui	a2,0x1
    80003270:	1884b583          	ld	a1,392(s1)
    80003274:	6ca8                	ld	a0,88(s1)
    80003276:	ffffe097          	auipc	ra,0xffffe
    8000327a:	ab8080e7          	jalr	-1352(ra) # 80000d2e <memmove>

  kfree(p->alarmdata.trapframe_cpy);    // remove the copy
    8000327e:	1884b503          	ld	a0,392(s1)
    80003282:	ffffd097          	auipc	ra,0xffffd
    80003286:	768080e7          	jalr	1896(ra) # 800009ea <kfree>
  p->alarmdata.trapframe_cpy=0;
    8000328a:	1804b423          	sd	zero,392(s1)
  p->alarmdata.currticks=0;
    8000328e:	1604ac23          	sw	zero,376(s1)
...
sys_waitx(void)
{
  ...
  uint wtime, rtime;
  argaddr(0, &addr);
    800032b6:	fd840593          	addi	a1,s0,-40
    800032ba:	4501                	li	a0,0
    800032bc:	00000097          	auipc	ra,0x0
    800032c0:	b92080e7          	jalr	-1134(ra) # 80002e4e <argaddr>
  argaddr(1, &addr1); // user virtual memory
    800032c4:	fd040593          	addi	a1,s0,-48
    800032c8:	4505                	li	a0,1
    800032ca:	00000097          	auipc	ra,0x0
    800032ce:	b84080e7          	jalr	-1148(ra) # 80002e4e <argaddr>
  argaddr(2, &addr2);
    800032d2:	fc840593          	addi	a1,s0,-56
    800032d6:	4509                	li	a0,2
    800032d8:	00000097          	auipc	ra,0x0
    800032dc:	b76080e7          	jalr	-1162(ra) # 80002e4e <argaddr>
  int ret = waitx(addr, &wtime, &rtime);
    800032e0:	fc040613          	addi	a2,s0,-64
    800032e4:	fc440593          	addi	a1,s0,-60
    800032e8:	fd843503          	ld	a0,-40(s0)
    800032ec:	fffff097          	auipc	ra,0xfffff
    800032f0:	f5a080e7          	jalr	-166(ra) # 80002246 <waitx>
    800032f4:	892a                	mv	s2,a0
  struct proc* p = myproc();
    800032f6:	ffffe097          	auipc	ra,0xffffe
    800032fa:	6b6080e7          	jalr	1718(ra) # 800019ac <myproc>
    800032fe:	84aa                	mv	s1,a0
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    80003300:	4691                	li	a3,4
    80003302:	fc440613          	addi	a2,s0,-60
    80003306:	fd043583          	ld	a1,-48(s0)
    8000330a:	6928                	ld	a0,80(a0)
    8000330c:	ffffe097          	auipc	ra,0xffffe
    80003310:	35c080e7          	jalr	860(ra) # 80001668 <copyout>
    return -1;
    80003314:	57fd                	li	a5,-1
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    80003316:	00054f63          	bltz	a0,80003334 <sys_waitx+0x8a>
  if (copyout(p->pagetable, addr2,(char*)&rtime, sizeof(int)) < 0)
    8000331a:	4691                	li	a3,4
    8000331c:	fc040613          	addi	a2,s0,-64
    80003320:	fc843583          	ld	a1,-56(s0)
    80003324:	68a8                	ld	a0,80(s1)
    80003326:	ffffe097          	auipc	ra,0xffffe
    8000332a:	342080e7          	jalr	834(ra) # 80001668 <copyout>
    8000332e:	00054a63          	bltz	a0,80003342 <sys_waitx+0x98>
    return -1;
  return ret;
    80003332:	87ca                	mv	a5,s2
}
    ...
    80003344:	bfc5                	j	80003334 <sys_waitx+0x8a>

0000000080003346 <sys_settickets>:
...
sys_settickets(void)
{
  ...
  struct proc *p = myproc();
    ...
    80003354:	65c080e7          	jalr	1628(ra) # 800019ac <myproc>
    80003358:	84aa                	mv	s1,a0
  acquire(&p->lock);
    8000335a:	ffffe097          	auipc	ra,0xffffe
    8000335e:	87c080e7          	jalr	-1924(ra) # 80000bd6 <acquire>
  int tickets;
  argint(0, &tickets);
    80003362:	fdc40593          	addi	a1,s0,-36
    80003366:	4501                	li	a0,0
    80003368:	00000097          	auipc	ra,0x0
    8000336c:	ac6080e7          	jalr	-1338(ra) # 80002e2e <argint>
  if(tickets < 0){
    80003370:	fdc42783          	lw	a5,-36(s0)
    80003374:	0207c063          	bltz	a5,80003394 <sys_settickets+0x4e>
    release(&p->lock);
    return -1;
  }
  p->tickets = tickets;
    80003378:	18f4a823          	sw	a5,400(s1)
  release(&p->lock);
  ...
  return p->tickets;
    80003386:	1904a503          	lw	a0,400(s1)
    ...
    800033a0:	b7ed                	j	8000338a <sys_settickets+0x44>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800033b6:	28e58593          	addi	a1,a1,654 # 80008640 <syscalls+0xd8>
    800033ba:	00014517          	auipc	a0,0x14
    800033be:	44e50513          	addi	a0,a0,1102 # 80017808 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    800033ce:	43e78793          	addi	a5,a5,1086 # 8001f808 <bcache+0x8000>
    800033d2:	0001c717          	auipc	a4,0x1c
    800033d6:	69e70713          	addi	a4,a4,1694 # 8001fa70 <bcache+0x8268>
    800033da:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800033de:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800033e2:	00014497          	auipc	s1,0x14
    800033e6:	43e48493          	addi	s1,s1,1086 # 80017820 <bcache+0x18>
    ...
    800033f2:	25aa0a13          	addi	s4,s4,602 # 80008648 <syscalls+0xe0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80003446:	3c650513          	addi	a0,a0,966 # 80017808 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80003456:	66e4b483          	ld	s1,1646(s1) # 8001fac0 <bcache+0x82b8>
    8000345a:	0001c797          	auipc	a5,0x1c
    8000345e:	61678793          	addi	a5,a5,1558 # 8001fa70 <bcache+0x8268>
    ...
    80003486:	38650513          	addi	a0,a0,902 # 80017808 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    800034a4:	6184b483          	ld	s1,1560(s1) # 8001fab8 <bcache+0x82b0>
    800034a8:	0001c797          	auipc	a5,0x1c
    800034ac:	5c878793          	addi	a5,a5,1480 # 8001fa70 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800034c4:	19050513          	addi	a0,a0,400 # 80008650 <syscalls+0xe8>
    ...
    800034e4:	32850513          	addi	a0,a0,808 # 80017808 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80003554:	11850513          	addi	a0,a0,280 # 80008668 <syscalls+0x100>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    8000358c:	28050513          	addi	a0,a0,640 # 80017808 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    800035b4:	25878793          	addi	a5,a5,600 # 8001f808 <bcache+0x8000>
    800035b8:	2b87b703          	ld	a4,696(a5)
    800035bc:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800035be:	0001c717          	auipc	a4,0x1c
    800035c2:	4b270713          	addi	a4,a4,1202 # 8001fa70 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    800035d6:	23650513          	addi	a0,a0,566 # 80017808 <bcache>
    ...
    800035f2:	08250513          	addi	a0,a0,130 # 80008670 <syscalls+0x108>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000360e:	1fe50513          	addi	a0,a0,510 # 80017808 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003624:	1e850513          	addi	a0,a0,488 # 80017808 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000364a:	1c250513          	addi	a0,a0,450 # 80017808 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003660:	1ac50513          	addi	a0,a0,428 # 80017808 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    8000368c:	85c7a783          	lw	a5,-1956(a5) # 8001fee4 <sb+0x1c>
  ...
  brelse(bp);
    ...
    800036e6:	f9650513          	addi	a0,a0,-106 # 80008678 <syscalls+0x110>
...
00000000800036f2 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    8000370c:	0001c797          	auipc	a5,0x1c
    80003710:	7c07a783          	lw	a5,1984(a5) # 8001fecc <sb+0x4>
    80003714:	10078163          	beqz	a5,80003816 <balloc+0x124>
    80003718:	8baa                	mv	s7,a0
    8000371a:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    8000371c:	0001cb17          	auipc	s6,0x1c
    80003720:	7acb0b13          	addi	s6,s6,1964 # 8001fec8 <sb>
  ...
  printf("balloc: out of blocks\n");
    ...
    8000381a:	e7a50513          	addi	a0,a0,-390 # 80008690 <syscalls+0x128>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003906:	da650513          	addi	a0,a0,-602 # 800086a8 <syscalls+0x140>
...
0000000080003912 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000392a:	5c250513          	addi	a0,a0,1474 # 8001fee8 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000393c:	5c848493          	addi	s1,s1,1480 # 8001ff00 <itable+0x18>
    80003940:	0001e697          	auipc	a3,0x1e
    80003944:	05068693          	addi	a3,a3,80 # 80021990 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003970:	57c50513          	addi	a0,a0,1404 # 8001fee8 <itable>
  ...
  release(&itable.lock);
    ...
    800039a0:	54c50513          	addi	a0,a0,1356 # 8001fee8 <itable>
    ...
    800039c2:	d0250513          	addi	a0,a0,-766 # 800086c0 <syscalls+0x158>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    800039ea:	0001c997          	auipc	s3,0x1c
    800039ee:	4de98993          	addi	s3,s3,1246 # 8001fec8 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003a22:	4aa58593          	addi	a1,a1,1194 # 8001fec8 <sb>
    ...
    80003a42:	c9250513          	addi	a0,a0,-878 # 800086d0 <syscalls+0x168>
...
0000000080003a4e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003a60:	c8c58593          	addi	a1,a1,-884 # 800086e8 <syscalls+0x180>
    80003a64:	0001c517          	auipc	a0,0x1c
    80003a68:	48450513          	addi	a0,a0,1156 # 8001fee8 <itable>
    80003a6c:	ffffd097          	auipc	ra,0xffffd
    80003a70:	0da080e7          	jalr	218(ra) # 80000b46 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003a74:	0001c497          	auipc	s1,0x1c
    80003a78:	49c48493          	addi	s1,s1,1180 # 8001ff10 <itable+0x28>
    80003a7c:	0001e997          	auipc	s3,0x1e
    80003a80:	f2498993          	addi	s3,s3,-220 # 800219a0 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003a84:	00005917          	auipc	s2,0x5
    80003a88:	c6c90913          	addi	s2,s2,-916 # 800086f0 <syscalls+0x188>
...
0000000080003aae <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80003ac8:	41072703          	lw	a4,1040(a4) # 8001fed4 <sb+0xc>
    ...
    80003ad8:	0001ca17          	auipc	s4,0x1c
    80003adc:	3f0a0a13          	addi	s4,s4,1008 # 8001fec8 <sb>
  ...
  printf("ialloc: no inodes\n");
    ...
    80003b26:	bd650513          	addi	a0,a0,-1066 # 800086f8 <syscalls+0x190>
...
0000000080003b80 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003b98:	34c5a583          	lw	a1,844(a1) # 8001fee0 <sb+0x18>
...
0000000080003c0c <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80003c1c:	2d050513          	addi	a0,a0,720 # 8001fee8 <itable>
  ...
  release(&itable.lock);
    ...
    80003c32:	2ba50513          	addi	a0,a0,698 # 8001fee8 <itable>
...
0000000080003c4a <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003c7e:	a9650513          	addi	a0,a0,-1386 # 80008710 <syscalls+0x1a8>
    ...
    80003c94:	2505a583          	lw	a1,592(a1) # 8001fee0 <sb+0x18>
    ...
    80003d00:	a1c50513          	addi	a0,a0,-1508 # 80008718 <syscalls+0x1b0>
...
0000000080003d0c <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003d4c:	9e050513          	addi	a0,a0,-1568 # 80008728 <syscalls+0x1c0>
...
0000000080003e04 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003e16:	0d650513          	addi	a0,a0,214 # 8001fee8 <itable>
  ...
  release(&itable.lock);
    ...
    80003e34:	0b850513          	addi	a0,a0,184 # 8001fee8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003e68:	08450513          	addi	a0,a0,132 # 8001fee8 <itable>
    ...
    80003e9e:	04e50513          	addi	a0,a0,78 # 8001fee8 <itable>
    ...
    80003f00:	0ed7e963          	bltu	a5,a3,80003ff2 <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003f62:	7e4080e7          	jalr	2020(ra) # 80002742 <either_copyout>
    ...
    80003ff8:	10d7e863          	bltu	a5,a3,80004108 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    8000405a:	742080e7          	jalr	1858(ra) # 80002798 <either_copyin>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    8000415c:	5d850513          	addi	a0,a0,1496 # 80008730 <syscalls+0x1c8>
    80004160:	ffffc097          	auipc	ra,0xffffc
    80004164:	3de080e7          	jalr	990(ra) # 8000053e <panic>
      panic("dirlookup read");
    80004168:	00004517          	auipc	a0,0x4
    8000416c:	5e050513          	addi	a0,a0,1504 # 80008748 <syscalls+0x1e0>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    8000420e:	7a2080e7          	jalr	1954(ra) # 800019ac <myproc>
    80004212:	15053503          	ld	a0,336(a0)
...
000000008000433e <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    800043e4:	37850513          	addi	a0,a0,888 # 80008758 <syscalls+0x1f0>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80004436:	0001d917          	auipc	s2,0x1d
    8000443a:	55a90913          	addi	s2,s2,1370 # 80021990 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000445e:	56678793          	addi	a5,a5,1382 # 800219c0 <log+0x30>
    ...
    8000446e:	0001d617          	auipc	a2,0x1d
    80004472:	55660613          	addi	a2,a2,1366 # 800219c4 <log+0x34>
...
00000000800044a4 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800044a8:	5187a783          	lw	a5,1304(a5) # 800219bc <log+0x2c>
    800044ac:	0af05d63          	blez	a5,80004566 <install_trans+0xc2>
{
    ...
    800044c6:	0001da97          	auipc	s5,0x1d
    800044ca:	4faa8a93          	addi	s5,s5,1274 # 800219c0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800044ce:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800044d0:	0001d997          	auipc	s3,0x1d
    800044d4:	4c098993          	addi	s3,s3,1216 # 80021990 <log>
...
0000000080004568 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000457e:	41648493          	addi	s1,s1,1046 # 80021990 <log>
    80004582:	00004597          	auipc	a1,0x4
    80004586:	1e658593          	addi	a1,a1,486 # 80008768 <syscalls+0x200>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800045be:	40670713          	addi	a4,a4,1030 # 800219c0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    800045f2:	3c07a723          	sw	zero,974(a5) # 800219bc <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000463c:	baa080e7          	jalr	-1110(ra) # 800021e2 <sleep>
    if(log.committing){
    ...
    80004668:	b7e080e7          	jalr	-1154(ra) # 800021e2 <sleep>
    8000466c:	bfd1                	j	80004640 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    8000466e:	0001d517          	auipc	a0,0x1d
    80004672:	32250513          	addi	a0,a0,802 # 80021990 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800046a2:	2f248493          	addi	s1,s1,754 # 80021990 <log>
  ...
  if(log.outstanding == 0){
    ...
    800046c6:	2ce48493          	addi	s1,s1,718 # 80021990 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800046e2:	2b248493          	addi	s1,s1,690 # 80021990 <log>
    ...
    800046fa:	c9c080e7          	jalr	-868(ra) # 80002392 <wakeup>
    release(&log.lock);
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000474c:	278a8a93          	addi	s5,s5,632 # 800219c0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004750:	0001da17          	auipc	s4,0x1d
    80004754:	240a0a13          	addi	s4,s4,576 # 80021990 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800047d6:	1e07a523          	sw	zero,490(a5) # 800219bc <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800047f6:	19e90913          	addi	s2,s2,414 # 80021990 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004834:	19070713          	addi	a4,a4,400 # 800219c0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004850:	14478793          	addi	a5,a5,324 # 80021990 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004868:	12c70713          	addi	a4,a4,300 # 80021990 <log>
    ...
    80004878:	f0c50513          	addi	a0,a0,-244 # 80008780 <syscalls+0x218>
    8000487c:	ffffc097          	auipc	ra,0xffffc
    80004880:	cc2080e7          	jalr	-830(ra) # 8000053e <panic>
    panic("log_write outside of trans");
    80004884:	00004517          	auipc	a0,0x4
    80004888:	f1450513          	addi	a0,a0,-236 # 80008798 <syscalls+0x230>
  ...
  log.lh.block[i] = b->blockno;
    ...
    800048a0:	0f470713          	addi	a4,a4,244 # 80021990 <log>
  ...
  release(&log.lock);
    ...
    800048b2:	0e250513          	addi	a0,a0,226 # 80021990 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800048de:	ede58593          	addi	a1,a1,-290 # 800087b8 <syscalls+0x250>
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    8000492c:	8ba080e7          	jalr	-1862(ra) # 800021e2 <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    8000493c:	074080e7          	jalr	116(ra) # 800019ac <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    80004984:	a12080e7          	jalr	-1518(ra) # 80002392 <wakeup>
  release(&lk->lk);
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004a00:	dcc58593          	addi	a1,a1,-564 # 800087c8 <syscalls+0x260>
    80004a04:	0001d517          	auipc	a0,0x1d
    80004a08:	0d450513          	addi	a0,a0,212 # 80021ad8 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    80004a56:	08650513          	addi	a0,a0,134 # 80021ad8 <ftable>
  ...
  return 0;
    ...
    80004a6e:	06e50513          	addi	a0,a0,110 # 80021ad8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004a96:	04650513          	addi	a0,a0,70 # 80021ad8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004ab0:	02c50513          	addi	a0,a0,44 # 80021ad8 <ftable>
  ...
  return f;
    ...
    80004acc:	d0850513          	addi	a0,a0,-760 # 800087d0 <syscalls+0x268>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004af0:	fec50513          	addi	a0,a0,-20 # 80021ad8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004b2a:	fb250513          	addi	a0,a0,-78 # 80021ad8 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004ca6:	d9670713          	addi	a4,a4,-618 # 80021a38 <devsw>
    ...
    80004cbc:	b3050513          	addi	a0,a0,-1232 # 800087e8 <syscalls+0x280>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004d46:	cf670713          	addi	a4,a4,-778 # 80021a38 <devsw>
  ...
  return ret;
    ...
    80004df0:	a0c50513          	addi	a0,a0,-1524 # 800087f8 <syscalls+0x290>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    80004e5c:	00003597          	auipc	a1,0x3
    80004e60:	62c58593          	addi	a1,a1,1580 # 80008488 <states.0+0x1b8>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    80004f0a:	48c080e7          	jalr	1164(ra) # 80002392 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004f40:	456080e7          	jalr	1110(ra) # 80002392 <wakeup>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004f74:	a3c080e7          	jalr	-1476(ra) # 800019ac <myproc>
  ...
  return i;
    ...
    80004fc2:	3d4080e7          	jalr	980(ra) # 80002392 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004fc6:	85a6                	mv	a1,s1
    80004fc8:	855e                	mv	a0,s7
    80004fca:	ffffd097          	auipc	ra,0xffffd
    80004fce:	218080e7          	jalr	536(ra) # 800021e2 <sleep>
  while(i < n){
    ...
    80004fe2:	604080e7          	jalr	1540(ra) # 800025e2 <killed>
  ...
  wakeup(&pi->nread);
    ...
    8000503a:	35c080e7          	jalr	860(ra) # 80002392 <wakeup>
  release(&pi->lock);
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80005094:	552080e7          	jalr	1362(ra) # 800025e2 <killed>
    ...
    800050a2:	144080e7          	jalr	324(ra) # 800021e2 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    80005104:	292080e7          	jalr	658(ra) # 80002392 <wakeup>
  release(&pi->lock);
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    80005188:	828080e7          	jalr	-2008(ra) # 800019ac <myproc>
 ...
 bad:
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    80005228:	84c080e7          	jalr	-1972(ra) # 80001a70 <proc_pagetable>
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80005254:	5b850513          	addi	a0,a0,1464 # 80008808 <syscalls+0x2a0>
  ...
  uint64 oldsz = p->sz;
    800052c2:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
  ...
  ustack[argc] = 0;
    ...
    80005386:	f007b023          	sd	zero,-256(a5) # ffffffffffffef00 <end+0xffffffff7ffdc330>
  ...
  p->trapframe->a1 = sp;
    800053b8:	058bb783          	ld	a5,88(s7) # 1058 <_entry-0x7fffefa8>
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    800053ea:	158b8513          	addi	a0,s7,344
    800053ee:	ffffc097          	auipc	ra,0xffffc
    800053f2:	a2e080e7          	jalr	-1490(ra) # 80000e1c <safestrcpy>
  oldpagetable = p->pagetable;
    800053f6:	050bb503          	ld	a0,80(s7)
  p->pagetable = pagetable;
    800053fa:	056bb823          	sd	s6,80(s7)
  p->sz = sz;
    800053fe:	058bb423          	sd	s8,72(s7)
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    8000541a:	6f6080e7          	jalr	1782(ra) # 80001b0c <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    ...
    80005432:	6de080e7          	jalr	1758(ra) # 80001b0c <proc_freepagetable>
  if(ip){
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    ...
    8000552a:	908080e7          	jalr	-1784(ra) # 80002e2e <argint>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80005582:	42e080e7          	jalr	1070(ra) # 800019ac <myproc>
    80005586:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    80005588:	0d050793          	addi	a5,a0,208
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    8000561a:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdc474>
  ...
  return ip;
    ...
    800056c0:	16c58593          	addi	a1,a1,364 # 80008828 <syscalls+0x2c0>
    ...
    800056d8:	15c58593          	addi	a1,a1,348 # 80008830 <syscalls+0x2c8>
...
000000008000578c <sys_read>:
{
  ...
  argaddr(1, &p);
    ...
    8000579e:	6b4080e7          	jalr	1716(ra) # 80002e4e <argaddr>
  argint(2, &n);
    800057a2:	fe440593          	addi	a1,s0,-28
    800057a6:	4509                	li	a0,2
    800057a8:	ffffd097          	auipc	ra,0xffffd
    800057ac:	686080e7          	jalr	1670(ra) # 80002e2e <argint>
  if(argfd(0, 0, &f) < 0)
...
00000000800057e4 <sys_write>:
{
  ...
  argaddr(1, &p);
    ...
    800057f6:	65c080e7          	jalr	1628(ra) # 80002e4e <argaddr>
  argint(2, &n);
    800057fa:	fe440593          	addi	a1,s0,-28
    800057fe:	4509                	li	a0,2
    80005800:	ffffd097          	auipc	ra,0xffffd
    80005804:	62e080e7          	jalr	1582(ra) # 80002e2e <argint>
  if(argfd(0, 0, &f) < 0)
...
000000008000583c <sys_close>:
{
  ...
  myproc()->ofile[fd] = 0;
    ...
    80005860:	150080e7          	jalr	336(ra) # 800019ac <myproc>
...
000000008000588a <sys_fstat>:
{
  ...
  argaddr(1, &st);
    ...
    8000589c:	5b6080e7          	jalr	1462(ra) # 80002e4e <argaddr>
  if(argfd(0, 0, &f) < 0)
...
00000000800058d0 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800058ea:	588080e7          	jalr	1416(ra) # 80002e6e <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005902:	570080e7          	jalr	1392(ra) # 80002e6e <argstr>
    return -1;
...
0000000080005a1a <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    80005a36:	43c080e7          	jalr	1084(ra) # 80002e6e <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80005a66:	dc658593          	addi	a1,a1,-570 # 80008828 <syscalls+0x2c0>
    ...
    80005a7e:	db658593          	addi	a1,a1,-586 # 80008830 <syscalls+0x2c8>
  ...
  return 0;
    ...
    80005b3e:	cfe50513          	addi	a0,a0,-770 # 80008838 <syscalls+0x2d0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005b8a:	cca50513          	addi	a0,a0,-822 # 80008850 <syscalls+0x2e8>
    80005b8e:	ffffb097          	auipc	ra,0xffffb
    80005b92:	9b0080e7          	jalr	-1616(ra) # 8000053e <panic>
    panic("unlink: writei");
    80005b96:	00003517          	auipc	a0,0x3
    80005b9a:	cd250513          	addi	a0,a0,-814 # 80008868 <syscalls+0x300>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005da2:	0d0080e7          	jalr	208(ra) # 80002e6e <argstr>
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005e74:	b3c080e7          	jalr	-1220(ra) # 800019ac <myproc>
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005e90:	fe2080e7          	jalr	-30(ra) # 80002e6e <argstr>
  ...
  iput(p->cwd);
    80005ec4:	15093503          	ld	a0,336(s2)
  ...
  p->cwd = ip;
    80005ed8:	14993823          	sd	s1,336(s2)
  return 0;
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005f7a:	e1a080e7          	jalr	-486(ra) # 80002d90 <fetchaddr>
    ...
    80005fa2:	e44080e7          	jalr	-444(ra) # 80002de2 <fetchstr>
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80006026:	98a080e7          	jalr	-1654(ra) # 800019ac <myproc>
  ...
  argaddr(0, &fdarray);
    ...
    80006036:	e1c080e7          	jalr	-484(ra) # 80002e4e <argaddr>
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800060f6:	0004b023          	sd	zero,0(s1)
    fileclose(rf);
...
0000000080006120 <kernelvec>:
    ...
    80006160:	afdfc0ef          	jal	ra,80002c5c <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    800061fc:	788080e7          	jalr	1928(ra) # 80001980 <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    80006234:	750080e7          	jalr	1872(ra) # 80001980 <cpuid>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80006288:	80c78793          	addi	a5,a5,-2036 # 80022a90 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80006298:	0001c797          	auipc	a5,0x1c
    8000629c:	7f878793          	addi	a5,a5,2040 # 80022a90 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    800062c4:	7e850513          	addi	a0,a0,2024 # 80022aa8 <disk+0x18>
    800062c8:	ffffc097          	auipc	ra,0xffffc
    800062cc:	0ca080e7          	jalr	202(ra) # 80002392 <wakeup>
}
    ...
    800062dc:	5a050513          	addi	a0,a0,1440 # 80008878 <syscalls+0x310>
    800062e0:	ffffa097          	auipc	ra,0xffffa
    800062e4:	25e080e7          	jalr	606(ra) # 8000053e <panic>
    panic("free_desc 2");
    800062e8:	00002517          	auipc	a0,0x2
    800062ec:	5a050513          	addi	a0,a0,1440 # 80008888 <syscalls+0x320>
...
00000000800062f8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80006308:	59458593          	addi	a1,a1,1428 # 80008898 <syscalls+0x330>
    8000630c:	0001d517          	auipc	a0,0x1d
    80006310:	8ac50513          	addi	a0,a0,-1876 # 80022bb8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80006374:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdbb8f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    800063b8:	0001c497          	auipc	s1,0x1c
    800063bc:	6d848493          	addi	s1,s1,1752 # 80022a90 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    800063dc:	0001c717          	auipc	a4,0x1c
    800063e0:	6bc73703          	ld	a4,1724(a4) # 80022a98 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    800063f4:	0001c497          	auipc	s1,0x1c
    800063f8:	69c48493          	addi	s1,s1,1692 # 80022a90 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006518:	6a450513          	addi	a0,a0,1700 # 80022bb8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80006526:	44a1                	li	s1,8
      disk.free[i] = 0;
    80006528:	0001cb97          	auipc	s7,0x1c
    8000652c:	568b8b93          	addi	s7,s7,1384 # 80022a90 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80006532:	0001cc97          	auipc	s9,0x1c
    80006536:	686c8c93          	addi	s9,s9,1670 # 80022bb8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80006554:	0001c717          	auipc	a4,0x1c
    80006558:	53c70713          	addi	a4,a4,1340 # 80022a90 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80006590:	51c50513          	addi	a0,a0,1308 # 80022aa8 <disk+0x18>
    80006594:	ffffc097          	auipc	ra,0xffffc
    80006598:	c4e080e7          	jalr	-946(ra) # 800021e2 <sleep>
  for(int i = 0; i < 3; i++){
    8000659c:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    800065b0:	0001c617          	auipc	a2,0x1c
    800065b4:	4e060613          	addi	a2,a2,1248 # 80022a90 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    8000661a:	0001c697          	auipc	a3,0x1c
    8000661e:	47668693          	addi	a3,a3,1142 # 80022a90 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    8000668a:	0001c917          	auipc	s2,0x1c
    8000668e:	52e90913          	addi	s2,s2,1326 # 80022bb8 <disk+0x128>
  while(b->disk == 1) {
    ...
    8000669c:	b4a080e7          	jalr	-1206(ra) # 800021e2 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800066b8:	3dc78793          	addi	a5,a5,988 # 80022a90 <disk>
    800066bc:	97ba                	add	a5,a5,a4
    800066be:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800066c2:	0001c997          	auipc	s3,0x1c
    800066c6:	3ce98993          	addi	s3,s3,974 # 80022a90 <disk>
  ...
  release(&disk.vdisk_lock);
    800066ea:	0001c517          	auipc	a0,0x1c
    800066ee:	4ce50513          	addi	a0,a0,1230 # 80022bb8 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006726:	36e48493          	addi	s1,s1,878 # 80022a90 <disk>
    8000672a:	0001c517          	auipc	a0,0x1c
    8000672e:	48e50513          	addi	a0,a0,1166 # 80022bb8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    80006786:	c10080e7          	jalr	-1008(ra) # 80002392 <wakeup>
  ...
  release(&disk.vdisk_lock);
    ...
    800067a6:	41650513          	addi	a0,a0,1046 # 80022bb8 <disk+0x128>
    ...
    800067c0:	1a450513          	addi	a0,a0,420 # 80008960 <syscalls+0x3f8>
